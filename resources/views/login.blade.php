...
<meta name="robots" content="index,follow">
    ...
    <body data-sa-theme="7" onload="checkCookie()">
        <div class="login">
...
function checkCookie() {
    var user=getCookie("authuser");
    if (user != "") {
       // alert("Welcome again " + user);
     
       console.log("success");
      // window.location.replace("https://system.nellymarine.com/index");
    } else {
       window.location.replace("https://system.nellymarine.com/error");
      console.log("failure");
    }
}
