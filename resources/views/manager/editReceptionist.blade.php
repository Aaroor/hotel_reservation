                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    	  ...
                    	  <ul>
                    		  ...
                    		  @if($msg==2)
                    		  <li class="navigation__active"><a href="{{route('update_receptionist_failure')}}">Update Receptionist Info</a></li>
                    		  @else
                    		  <li class="navigation__active"><a href="{{route('index_update_receptionist', ['id'=>$userInfo->user_id])}}">Update Receptionist Info</a></li>
                    		  @endif
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            {{Form::open(['action'=>'ManagerController@updateReceptionist','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
