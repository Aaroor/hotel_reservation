        ...
        <main class="main">
            ...
            <section class="content">
                <header class="content__title">
                    <a href="{{route('man_rep_check_rooms')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>All Search</a>
                ...
                <div class="card">
                    ...
                    {{Form::open(['action'=>'ManagerController@manReportCheckRoomsDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'print_check_out_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateValidation()'])}}
                       @if($msg==0)
