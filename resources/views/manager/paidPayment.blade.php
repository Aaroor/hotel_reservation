        ...
        <main class="main">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--togglede">
                    		...
                    		<ul>
                    			...
                    			<li class="navigation__active"><a href="{{route('man_index_paid_payment')}}">Paid Payments</a></li>
            ...
            <section class="content">
                <header class="content__title">
                    <a href="{{route('man_index_paid_payment')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>All Search</a>
                ...
                <div class="card">
                    ...
                    <br><br>
                        ...
                        {{Form::open(['action'=>'ManagerController@manPaidSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                            <div class="row">
                                <div class="col-sm-4">
                        ...
                        {{Form::open(['action'=>'ManagerController@manPaidDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                        <div class="row">
                            <div class="col-sm-4">
                                 ...
                                 <?php
                                  ...
                                  ?>
                                	...
                                	<tr style="font-size: 16px">
                                		...
                                		<td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Press for checkout invoice" href="{{route('man_add_check_out', ['id'=>$checkOutInfo->invoice_id])}}" class="btn btn-light btn--icon-text"><i style="font-size: 18px" class="zmdi zmdi-check"></i></a></td>
                                		@if($checkOutInfo->bill_lock==0)
                                		<td id="td{{$checkOutInfo->invoice_id}}"><a  href="{{route('man_print_bill', ['id'=>$checkOutInfo->invoice_id])}}" class="btn btn-success btn--icon-text" id="{{$checkOutInfo->invoice_id}}" onclick="clickEv(this.id)"><i style="font-size: 18px" class="zmdi zmdi-print"></i> Print</a></td>
                		...
                		<div class="modal-dialog">
                			<div class="modal-content">
                				...
                				<p style="font-size:12px"><i class="zmdi zmdi-info-outline"></i>&nbspYou can't print bill with out manager approval. Please make a request to manger for an approval</p>
                					{{Form::open(['action'=>'ManagerController@manBillPrintsAppP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_man_form', 'method'=>'POST','role'=>'form'])}}
