        ...
        <main class="main">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    			...
                    			<li class="navigation__active"><a href="{{route('man_payment_history_r', ['id'=>session('pay_inv_id')])}}">Payment History</a></li>
            ...
            <section class="content">
                <header class="content__title">
                    <a href="{{route('man_payment_history_r', ['id'=>session('pay_inv_id')])}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>All Search</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a href="{{route('man_remove_pay_history', ['id'=>$payHistoryInfo->history_id])}}" class="btn btn-link">Approve</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <p style="font-size:12px"><i class="zmdi zmdi-info-outline"></i>&nbspYou can't remove history with out manager approval. Please make a request to manger for an approval</p>
                                    {{Form::open(['action'=>'ManagerController@manPayRemoveAppP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form'])}}
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <p style="font-size:12px"><i class="zmdi zmdi-info-outline"></i>&nbspYou can't print bill with out manager approval. Please make a request to manger for an approval</p>
                                    {{Form::open(['action'=>'ManagerController@manBillPrintsAppP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form'])}}
