        ...
        <main class="main">
                    ...
                    <ul class="navigation">
						...
						<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
							...
							<ul>
							   ...
							   <li class="navigation__active"><a href="{{route('man_room_list')}}">Room List</a></li>
						   </ul>
						</li>
            ...
            <section class="content">
                <header class="content__title">
                    ...
                    <div class="actions">
                            <a href="{{route('man_room_list')}}" class="actions__item zmdi zmdi-refresh"></a>
                            ...
                            <table id="data-table" class="table">
                                ...
                                @foreach($roomInfos as $roomInfo)
                                    <tr style="font-size: 16px">
                                        ...
                                        <td><a href="{{route('man_edit_room_r', ['id'=>$roomInfo->room_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>&nbsp
                     ...
                     <div class="modal-dialog">
                         <div class="modal-content">
                             ...
                             <div class="modal-footer">
                                 <a href="{{route('man_remove_room_r', ['id'=>$roomInfo->room_id])}}" class="btn btn-link">Approve</a>
