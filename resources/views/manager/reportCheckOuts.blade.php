        ...
        <main class="main">
            ...
            <section class="content">
                <header class="content__title">
                    <a href="{{route('man_rep_check_out')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>All Search</a>
                ...
                <div class="card">
                    ...
                    {{Form::open(['action'=>'ManagerController@manReportCheckDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'print_check_out_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateValidation()'])}}
                       @if($msg==0)
                                           <label class="custom-control custom-radio">
                                               <input type="radio" value="4" name="radio-inline" onchange="setSearchType()"  class="custom-control-input" checked>
                                               <span class="custom-control-indicator"></span>
                                               <span class="custom-control-description">All Bookings</span>
                                           </label>
                                           <label class="custom-control custom-radio">
                                               <input type="radio" value="0" name="radio-inline" onchange="setSearchType()"  class="custom-control-input">
                                               <span class="custom-control-indicator"></span>
                                               <span class="custom-control-description">Nelly Marine</span>
                                           </label>
                                           <label class="custom-control custom-radio">
                                               <input type="radio" value="1" name="radio-inline" onchange="setSearchType()"  class="custom-control-input">
                                               <span class="custom-control-indicator"></span>
                                               <span class="custom-control-description">Booking.com</span>
                                           </label>
                                           <label class="custom-control custom-radio">
                                               <input type="radio" value="2" name="radio-inline" onchange="setSearchType()"  class="custom-control-input">
                                               <span class="custom-control-indicator"></span>
                                               <span class="custom-control-description">Room Brokers</span>
                                           </label>
                                           <label class="custom-control custom-radio">
                                               <input type="radio" value="3" name="radio-inline" onchange="setSearchType()"  class="custom-control-input">
                                               <span class="custom-control-indicator"></span>
                                       ...
                                       @elseif($msg==1)
                                           ...
                                           @else
                                           <label class="custom-control custom-radio">
                                               <input type="radio" value="4" name="radio-inline"  onchange="setSearchType()" class="custom-control-input">
                                               <span class="custom-control-indicator"></span>
                                               <span class="custom-control-description">All Bookings</span>
                                           </label>
                                           @endif
                                           ...
                                           <label class="custom-control custom-radio">
                                               <input type="radio" value="0" name="radio-inline" onchange="setSearchType()"  class="custom-control-input" checked>
                                               <span class="custom-control-indicator"></span>
                                               <span class="custom-control-description">Nelly Marine</span>
                                           </label>
                                           @else
                                           ...
                                           <label class="custom-control custom-radio">
                                               <input type="radio" value="1" name="radio-inline" onchange="setSearchType()" class="custom-control-input" checked>
                                               <span class="custom-control-indicator"></span>
                                               <span class="custom-control-description">Booking.com</span>
                                           </label>
                                           @else
                                           ...
                                           <label class="custom-control custom-radio">
                                               <input type="radio" value="2" name="radio-inline" onchange="setSearchType()"  class="custom-control-input" checked>
                                               <span class="custom-control-indicator"></span>
                                               <span class="custom-control-description">Room Brokers</span>
                                           </label>
                                           @else
                                           ...
                                           <label class="custom-control custom-radio">
                                               <input type="radio" value="3" name="radio-inline" onchange="setSearchType()"  class="custom-control-input" checked>
                                               <span class="custom-control-indicator"></span>
                                               <span class="custom-control-description">Others</span>
                                           </label>
                                           @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                ...
                                <div class="input-group">
                                    <div class="form-group">
                                     @if($msg==0)
                                        <a href="{{route('man_rep_check_bill')}}" class="btn btn-success btn--icon-text"><i style="font-size: 18px" class="zmdi zmdi-print"></i> Print</a>
                                     @else
                                        <a href="{{route('man_rep_check_bill_duration')}}" class="btn btn-success btn--icon-text"><i style="font-size: 18px" class="zmdi zmdi-print"></i> Print</a>
                                     @endif
                                    </div>
                                </div>
                                 ...
                                 <?php
                                  ...
                                  ?>
                                	...
                                	<tr style="font-size: 16px">
                                        ...
                                        <a href="#modal_{{$checkOutInfo->invoice_id}}" data-toggle="modal" data-target="#modal_{{$checkOutInfo->invoice_id}}">More Details ...</a>
                                        </td>
                                		<td>
                 ...
                 @foreach($checkOutInfos as $checkOutInfo)
                	<div class="modal fade" id="modal_{{$checkOutInfo->invoice_id}}" tabindex="-1">
