                ...
                <div class="scrollbar-inner">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    		   <li class="navigation__active"><a href="{{route('man_index_add_room')}}">Add Room</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                @elseif($msg==2)
                                     <div class="alert alert-danger alert-dismissible fade show">
                                            ...
                                            <strong>{{$cmt}}</strong><br> This room number already in the system please try with different room number
                                     </div>
                                @endif
                                </div>
                            ...
                            <br>
                            {{Form::open(['action'=>'ManagerController@manAddRooms','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                                <div class="row">
                                <div class="col-sm-1">
                                </div>
                                <div class="col-sm-5">
