        ...
        <main class="main">
            ...
            <aside class="sidebar">
                <div class="scrollbar-inner">
                   ...
                   <ul class="navigation">
                   	...
                   	<li class="navigation__sub navigation__sub--active navigation__sub--togglede">
                   		<a href=""><i class="zmdi zmdi-money-box zmdi-hc-fw"></i> Payment</a>

                   		<ul>
                   			<li class="navigation__active"><a href="{{route('man_index_check_out_payment')}}">Payment Check Out</a></li>
            ...
            <section class="content">
                <header class="content__title">
                    {{--<h1>Payment Check Out List</h1>--}}
                    {{--<div class="row">--}}
                      {{--<div class="col-sm-2">--}}
                        <a href="{{route('man_index_check_out_payment')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>Search All</a>
                      {{--</div>--}}
                ...
                <div class="card">
                    ...
                    <br><br>
                        ...
                        {{Form::open(['action'=>'ManagerController@manCheckOutDateSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                            <div class="row">
                                <div class="col-sm-4">
                        ...
                        {{Form::open(['action'=>'ManagerController@manCheckOutDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                        <div class="row">
                            <div class="col-sm-4">
                                 ...
                                 <?php
                                  ...
                                  ?>
                                	...
                                	<tr style="font-size: 16px">
                                		...
                                		<td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Paid History For Invoice" href="{{route('man_payment_history_r', ['id'=>$checkOutInfo->invoice_id])}}" class="btn btn-light"><i style="font-size: 18px" class="zmdi zmdi-time-restore"></i></a></td>
                                		<td><a href="{{route('man_bill_payment', ['id'=>$checkOutInfo->invoice_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-money-box"></i></a></td>
                                		<td><button class="btn btn-light" data-toggle="modal" data-target="#modal-default_calc"><i style="font-size: 18px" class="zmdi zmdi-exposure" data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Calculator"></i> </button></td>
                                		@if($checkOutInfo->bill_lock==0)
                                        <td><a href="{{route('man_print_bill', ['id'=>$checkOutInfo->invoice_id])}}" class="btn btn-success btn--icon-text"><i style="font-size: 18px" class="zmdi zmdi-print"></i>Print</a></td>
                                        @else
                                        <td><button class="btn btn-light" data-toggle="modal" data-target="#modal-default_approve_print{{$checkOutInfo->invoice_id}}"><i style="font-size: 18px" class="zmdi zmdi-print"></i> </button></td>
                                        @endif
                		...
                		<div class="modal-content">
                			...
                			<div class="modal-body">
                				...
                				<table class="table mb-3">
                					...
                					<tr>
                						<th scope="row">{{$cont=$cont+1}}</th>
                						<td>@if($meals_info->getMealsInfo($order_info->getOrderDetails($orderPayment->order_id)->meals_id)->meals_type==4)Drinks Name : @else Meals Name : @endif
                						{{$meals_info->getMealsInfo($order_info->getOrderDetails($orderPayment->order_id)->meals_id)->meals_name}}<br>Order Date : {{$order_info->getOrderDetails($orderPayment->order_id)->order_date}}
