        ...
        <main class="main">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    	  ...
                    	  <ul>
                    		  ...
                    		  <li class="navigation__active"><a href="{{route('receptionist_list')}}">Receptionist List</a></li>
            ...
            <section class="content">
                <header class="content__title">
                    ...
                    <div class="actions">
                            <a href="" class="actions__item zmdi zmdi-refresh"></a>
                            ...
                            <table id="data-table" class="table">
                                ...
                                @foreach($userInfos as $userInfo)
                                    <tr style="font-size: 16px">
                                        ...
                                        <td><a href="{{route('index_update_receptionist', ['id'=>$userInfo->user_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>&nbsp
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="{{route('remove_receptionist', ['id'=>$userInfo->user_id])}}" class="btn btn-link">Approve</a>
