    ...
    <body data-sa-theme="{{$user_info->getUserInfo(session('user_id'))->theme_id}}">
        <main class="main">
                   ...
                   <ul class="navigation">
                   	...
                   	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                   		...
                   		<ul>
                   			...
                   			<li class="navigation__active"><a href="{{route('man_index_order_list')}}">Order List</a></li>
                   	...
                   	<li class="navigation__sub @@uiactive">
                           ...
                           <li class="@@colorsactive"><a href="{{route('man_rep_current_booking')}}">Current Booking Report</a></li>
                           <li class="@@colorsactive"><a href="{{route('man_rep_check_rooms')}}">Check Out Rooms Report</a></li>
                   	   </ul>
                   	</li>
            ...
            <section class="content">
             <a href="{{route('man_index_order_list')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>Search All</a>
             <br><br>
                ...
                <div class="card">
                    ...
                    <br><br>
                        ...
                        <label class="custom-control custom-radio">
                        	...
                        	{{Form::open(['action'=>'ManagerController@manOrderDateSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                        		<div class="row">
                        			<div class="col-sm-4">
                        	...
                        	{{Form::open(['action'=>'ManagerController@manOrderDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                        	<div class="row">
                        		<div class="col-sm-4">
                                ...
                                @if(count($orderInfos)!=0)
                                 @foreach($orderInfos as $orderInfo)
                                	<tr style="font-size: 16px">
                                		...
                                		<td style="font-size: 14px"><strong><a href="{{route('man_bill_payment', ['id'=>$orderInfo->invoice_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-money"></i></a></strong></td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="font-size: 16px">
                                {{Form::open(['action'=>'ManagerController@manUpdateMealsOrderP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form'])}}
                                		...
                                		<div class="row">
                                			<div class="col-sm-6">
                                				 <div class="form-group">
                                					 ...
                                					 <input type="hidden" name="total_amount" id="ta{{$orderInfo->order_id}}" value="{{number_format((float)$total_amount,2,'.','')}}" />
                                					 <i class="form-group__bar"></i>
                                				 </div>
                                			 </div>
                                			<div class="col-sm-6">
                ...
                @foreach($orderInfos as $orderInfo)
                     ...
                     <div class="modal fade" id="modal-default{{$orderInfo->order_id}}" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title pull-left">Make sure to remove meals order</h5>
                                </div>
                                <div class="modal-body" style="font-size: 16px">
                                ...
                                <div class="modal-footer">
                                    <a href="{{route('man_remove_order', ['id'=>$orderInfo->order_id])}}" class="btn btn-link">Approve</a>
                                    <button type="button" class="btn btn-link" data-dismiss="modal">Close</button>
                                </div>
                            </div>
                        </div>
                	...
                	<div class="modal-dialog">
                		<div class="modal-content">
                			...
                			<p style="font-size:12px"><i class="zmdi zmdi-info-outline"></i>&nbspYou can't remove any order data with out manager approval. Please make a request to manger for an approval</p>
                				{{Form::open(['action'=>'ManagerController@manRemoveMealsAppP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form'])}}
                		...
                		<div class="modal-dialog">
                			<div class="modal-content">
                				...
                				<p style="font-size:12px"><i class="zmdi zmdi-info-outline"></i>&nbspYou can't modify any order data with out manager approval. Please make a request to manger for an approval</p>
                					{{Form::open(['action'=>'ManagerController@manEditMealsAppP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form'])}}
