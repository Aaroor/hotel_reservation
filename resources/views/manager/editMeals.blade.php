                    ...
                    <ul class="navigation">
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                               ...
                               <li class="navigation__active"><a href="{{route('man_edit_meals_r', ['id'=>$mealsInfo->meals_id])}}">Edit Meals</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            {{Form::open(['action'=>'ManagerController@manEditMealsP','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <a style="font-size: 16px" href="{{route('man_meals_list')}}" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-accounts-list"></i> Meals List</a>
