        ...
        <main class="main">
                    	...
                    	<li class="@@colorsactive"><a href="{{route('manager_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                    	 ...
                    	 <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                                ...
                                <li class="navigation__active"><a href="{{route('man_index_check_booking_list')}}">Check Out Bookings</a></li>
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <a href="{{route('man_index_check_booking_list')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i> All Bookings</a>
                    <br><br>

                    {{Form::open(['action'=>'ManagerController@manCheckBookingSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'print_check_out_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateValidation()'])}}
