        ...
        <main class="main">
            ...
            <aside class="sidebar sidebar--hidden">
                <div class="scrollbar-inner">
                    ...
                    <ul class="navigation">
                        <li class="navigation__active"><a href="{{route('manager_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                            ...
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('man_check_map')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a>
</small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        <h2>Meals Order</h2>
                                        <small> <a href="{{route('man_index_order_meals')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a>
</small>
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="stats__item">
                               ...
                               <div class="stats__info">
                                   <div>
                                       ...
                                       <small> <a href="{{route('man_index_airport_booking')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a>
</small>
                                   </div>
                               </div>
                           </div>
                            ...
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('man_cus_list')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a>
</small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        <h2>Payment</h2>
                                        <small> <a href="{{route('man_index_check_out_payment')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('man_meals_order_app')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('man_index_add_room')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('man_add_meals')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        <h2>Reports</h2>
                                        <small> <a href="{{route('man_day_summary')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('add_receptionist')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        <h2>User History</h2>
                                        <small> <a href="{{route('man_cus_booking_history')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
