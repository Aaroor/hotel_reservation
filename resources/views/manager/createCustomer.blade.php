        ...
        <main class="main">
                    	...
                    	<li class="@@colorsactive"><a href="{{route('manager_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                    	 ...
                    	 <li class="navigation__sub navigation__sub--active navigation__sub--toggle">
                    		...
                    		<ul>
                                ...
                                <li class="@@colorsactive"><a href="{{route('man_index_booking_info', ['id'=>session('s_room_id')])}}">Add Booking</a></li>
                                <li class="navigation__active"><a href="{{route('man_create_new_customer')}}">Add Customer</a></li>
            ...
            <header class="content__title">
                ...
                <div class="actions">
                        ...
                        <a href="{{route('admin_index_add_customer')}}" class="actions__item zmdi zmdi-refresh"></a>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            {{Form::open(['action'=>'ManagerController@manAddNewCustomer','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input style="font-size: 16px" name="cus_phone" type="number" class="form-control" placeholder="0000000000000">
                                        <i class="form-group__bar"></i>
                                    </div>
                                    <br>
                                 ...
                                 <div class="col-sm-5">
                                     {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="cus_nic_pass" type=text" class="form-control" placeholder="eg: NIC/Passport">
                                            <i class="form-group__bar"></i>
                                        </div>
                                     {{--</div>--}}
                                     <br>
