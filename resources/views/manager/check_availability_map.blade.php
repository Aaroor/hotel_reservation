    ...
    <body data-sa-theme="{{$user_info->getUserInfo(session('user_id'))->theme_id}}">
        <main class="main">
                    ...
                    <ul class="navigation">
                    	<li class="@@colorsactive"><a href="{{route('manager_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                    	 ...
                    	 <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    			<li class="navigation__active"><a href="{{route('man_check_map')}}">Availability Map</a></li>
                                ...
                                <li class="@@cssanimationsactive"><a href="{{route('man_index_booking_list')}}">Booking List</a></li>
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        {{Form::open(['action'=>'ManagerController@manAvailableRoomsSearchMap','class'=>'form-horizontal form-label-left input_mask','name'=>'single_booking_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateSearchValidation()'])}}
                        <div class="row">
                            <div class="col-sm-4">
                        ...
                        <a href="{{route('man_check_map_bulk')}}" data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="For Bulk Booking" class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-arrow-forward"></i>Go To Bulk Booking</a>
                        <br>
                                ...
                                <div class="col-sm-4 col-md-2">
                                    <div class="stats__item" style="background-color: green">
                                        <div class="stats__chart" style="text-align: center;">
                                            ...
                                            <a href="{{route('man_index_booking_info', ['id'=>$roomInfo->room_id])}}" data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="For Booking" class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-arrow-forward"></i></a>
                                        </div>
                                ...
                                <div class="col-sm-4 col-md-2">
                                    <div class="stats__item" style="background-color: orange">
                                        <div class="stats__chart" style="text-align: center;">
                                            ...
                                            <h4>{{$roomInfo->room_number}}</h4>
                                            <h6>{{$dec_room_type->getRoomType($roomInfo->room_type)}}</h6>
                                            <a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Booking Cancel" href="{{route('man_cancel_booking', ['id'=>$remove_id->getBookingIdTwo($from_date,$to_date,$roomInfo->room_id)])}}" class="btn btn-danger btn--icon-text" href=""><i class="zmdi zmdi-close"></i></a>
                                            <a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Continue Booking" href="{{route('man_con_booking_info', ['id'=>$roomInfo->room_id,'from'=>$from_date,'to'=>$to_date])}}" class="btn btn-success btn--icon-text" href=""><i class="zmdi zmdi-check"></i></a>
                                        </div>
                                    	...
                                    	@if(count($historyInfo->checkHistory($from_date,$to_date,$roomInfo->room_id))!=0)
                                    	 @if($is_available->checkAvailable($from_date,$to_date,$roomInfo->room_id)==2)
                                            ...
                                            <tr>
                                                ...
                                                <td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Direct To Payment" href="{{route('man_bill_payment', ['id'=>$bookingInfo->invoice_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-money"></i></a>&nbsp
                                                <a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Check out payment" href="{{route('man_pay_check', ['id'=>$bookingInfo->invoice_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-shopping-cart"></i></a>
                                                <a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Go to booking list" href="{{route('man_direct_to_booking_list', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-format-list-bulleted"></i></a>
                                                <a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Make Orders For Meals" href="{{route('man_re_meals_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-cutlery"></i></a>
                                                <a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Make Booking For Airport Pick Up/Drop" href="{{route('man_re_air_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-car-taxi"></i></a>
                                                <a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Add another booking for invoice" href="{{route('man_re_room_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-hotel"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                         @endif
