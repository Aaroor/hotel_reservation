                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    		   ...
                    		   <li class="navigation__active"><a href="{{route('man_bill_payment', ['id'=>session('p_invoice_id')])}}">Bill Payment</a></li>
                    		   <li class="@@colorsactive"><a href="{{route('man_payment_preview', ['id'=>session('p_invoice_id')])}}">Payment Preview</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                         ...
                         {{Form::open(['action'=>'ManagerController@manAddPayment','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="from_date" type="text" class="form-control" value="{{number_format((float)$checkOutPayInfo->total_amount,2,'.','')}}" disabled>
                                            <i class="form-group__bar"></i>
                                        </div>
                                ...
                                <div class="col-sm-5">
                                     <div class="form-group">
                                        ...
                                        <?php $outPay=$checkOutPayInfo->total_amount-$checkOutPayInfo->paid_amount;?>
