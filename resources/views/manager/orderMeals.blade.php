    ...
    <body data-sa-theme="{{$user_info->getUserInfo(session('user_id'))->theme_id}}">
        <main class="main">
                ...
                <div class="scrollbar-inner">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    			<li class="navigation__active"><a href="{{route('man_index_order_meals')}}">Choose Meals</a></li>
            ...
            <section class="content">
                ...
                {{Form::open(['action'=>'ManagerController@manAddBookingId','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                    <div class="row">
            ...
            {{Form::close()}}
             @else
             <a href="{{route('man_check_map')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-hotel"></i>Add Booking</a>
             <br><br>
             @endif
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="font-size: 16px">
                                    ...
                                    {{--</div>--}}
                                     {{Form::open(['action'=>'ManagerController@manAddMealsOrderP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                 ...
                                                 <?php $total_amount=$mealsInfo->price_per_unit*1;?>
                                                     ...
                                                     <input type="hidden" name="total_amount" id="ta{{$mealsInfo->meals_id}}" value="0.0" />
                                                     <i class="form-group__bar"></i>
                                                 </div>
                                             </div>
                                            <div class="col-sm-6">
