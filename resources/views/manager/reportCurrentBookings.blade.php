        ...
        <main class="main">
            ...
            <section class="content">
                <header class="content__title">
                    <a href="{{route('man_rep_current_booking')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>All Search</a>
                ...
                <div class="card">
                    ...
                    {{Form::open(['action'=>'ManagerController@manReportCurrentBookingDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'print_check_out_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateValidation()'])}}
                    @if($msg==0)
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                ...
                                <div class="input-group">
                                    <div class="form-group">
                                     @if($msg==0)
                                        <a href="{{route('man_rep_current_booking_bill')}}" class="btn btn-success btn--icon-text"><i style="font-size: 18px" class="zmdi zmdi-print"></i> Print</a>
                                     @else
                                        <a href="{{route('man_rep_current_booking_bill_duration')}}" class="btn btn-success btn--icon-text"><i style="font-size: 18px" class="zmdi zmdi-print"></i> Print</a>
                                     @endif
                                    </div>
                                </div>
