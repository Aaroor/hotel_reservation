                            ...
                            <table id="data-table" class="table">
                                ...
                                @foreach($cusInfos as $cusInfo)
                                    <tr style="font-size: 16px">
                                        ...
                                        <td><a href="{{route('man_index_cus_edit', ['id'=>$cusInfo->cus_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>&nbsp
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="{{route('man_remove_customer', ['id'=>$cusInfo->cus_id])}}" class="btn btn-link">Approve</a>
