    ...
    <body data-sa-theme="{{$user_info->getUserInfo(session('user_id'))->theme_id}}">
        <main class="main">
                    	...
                    	<li class="@@colorsactive"><a href="{{route('manager_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                    	 ...
                    	 <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                                ...
                                <li class="navigation__active"><a href="{{route('man_index_booking_list')}}">Booking List</a></li>
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-body">
                    <a href="{{route('man_index_all_booking_list')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i> All Bookings</a>
                                        <br><br>

                    {{Form::open(['action'=>'ManagerController@manBookingSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                                ...
                                @foreach($bookingInfos as $bookingInfo)
                                    <tr style="font-size: 16px">
                                        ...
                                        @endif
                                           ...
                                           @if($bookingInfo->status==1)
                                           <td><a href="{{route('man_stop_process', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-close"></i></a></td>
                                           @else
                                          ...
                                          <td>
                                           ...
                                           <a  href="{{route('man_edit_booking_info', ['id'=>$bookingInfo->booking_id])}}"  class="btn btn-light" data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Edit Booking"><i  style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>
                                          ...
                                          @if($bookingInfo->status==2)
                                           ...
                                           @else
                                           <td style="font-size: 14px"><strong><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Direct To Payment" href="{{route('man_bill_payment', ['id'=>$bookingInfo->invoice_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-money"></i></a></strong></td>
                                           @endif
                                          @else
                                          ...
                                          @if($bookingInfo->status==2)
                                           <td style="font-size: 14px"><strong><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Check out payment" href="{{route('man_pay_check', ['id'=>$bookingInfo->invoice_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-shopping-cart"></i></a></strong></td>
                                          @else
                                          ...
                                          @endif
                                            ...
                                            @else
                                              ...
                                              <td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Make Orders For Meals" href="{{route('man_re_meals_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-cutlery"></i></a></td>
                                            @endif
                                            ...
                                            @else
                                              {{--<td><a href="{{route('admin_cancel_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-close"></i>For Cancel</a></td>--}}
                                              {{--<td><button class="btn btn-light" data-toggle="modal" data-target="#modal-default{{$bookingInfo->booking_id}}"><i style="font-size: 18px" class="zmdi zmdi-plus-circle-o"></i></button></td>--}}
                                              <td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Make Booking For Airport Pick Up/Drop" href="{{route('man_re_air_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-car-taxi"></i></a></td>
                                            @endif

                                            @if($bookingInfo->status==1)
                                              <td><button  class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-plus-circle-o" disabled></i></button></td>
                                            @else
                                              <td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Add another booking for invoice" href="{{route('man_re_room_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-hotel"></i></a></td>
                                            @endif
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="{{route('man_remove_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-link">Approve</a>
