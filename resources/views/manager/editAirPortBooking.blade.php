                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		 ...
                    		 <ul>
                    		  ...
                    		  <li class="navigation__active"><a href="{{route('man_edit_air_booking', ['id'=>$aBookingInfo->a_booking_id])}}">Edit Booking</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                             {{Form::open(['action'=>'ManagerController@manEditAirPortBookingP','class'=>'form-horizontal form-label-left input_mask','name'=>'air_booking_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return airportBookingFormValidation()'])}}
