    ...
    <body data-sa-theme="{{$user_info->getUserInfo(session('user_id'))->theme_id}}">
        <main class="main">
                    	...
                    	<li class="@@colorsactive"><a href="{{route('manager_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                         ...
                         <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                ...
                                <li class="navigation__active"><a href="{{route('man_check_map_bulk')}}">Bulk Booking</a></li>
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        {{Form::open(['action'=>'ManagerController@manAvailableRoomsSearchBulkMap','class'=>'form-horizontal form-label-left input_mask','name'=>'single_booking_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateSearchValidation()'])}}
                        ...
                        <br><br>
                        {{Form::open(['action'=>'ManagerController@manBulkTempBooking','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_bulk_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editBulkValidation()'])}}
                         {{--{{Form::open(['action'=>'ReceptionistController@recBulkTempBooking','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_bulk_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editBulkValidation()'])}}--}}
                         <div class="form-group">
                                ...
                                <div class="col-sm-4 col-md-2">
                                    <div class="stats__item" style="background-color: orange">
                                        <div class="stats__chart" style="text-align: center;">
                                            ...
                                            <h4>{{$roomInfo->room_number}}</h4>
                                            <h6>{{$dec_room_type->getRoomType($roomInfo->room_type)}}</h6>
                                            <a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Booking Cancel" href="{{route('man_cancel_booking_map_bulk', ['id'=>$remove_id->getBookingIdTwo($from_date,$to_date,$roomInfo->room_id)])}}" class="btn btn-danger btn--icon-text" href=""><i class="zmdi zmdi-close"></i></a>
