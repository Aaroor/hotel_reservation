                    ...
                    <ul class="navigation">
                     ...
                     <li class="navigation__sub navigation__sub--active navigation__sub--toggle">
                        ...
                        <ul>
                           ...
                           <li class="@@colorsactive"><a href="{{route('man_bulk_booking_details')}}">Add Booking</a></li>
                           <li class="navigation__active"><a href="{{route('man_create_new_bulk_customer')}}">Add Customer</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            {{Form::open(['action'=>'ManagerController@manAddNewBulkCustomer','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
