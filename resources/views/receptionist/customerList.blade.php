                       ...
                       <li class="@indexactivehp"><a href="{{route('receptionist_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                       	...
                       	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                       	  ...
                       	  <ul>
                       	   ...
                       	   <li class="navigation__active"><a href="{{route('res_cus_list')}}">Customer List</a></li>
                       	  </ul>
                       	</li>
                        <li class="navigation__sub @@uiactive">
                            ...
                            <table id="data-table" class="table">
                                ...
                                @foreach($cusInfos as $cusInfo)
                                    <tr style="font-size: 16px">
                                        ...
                                        <td><a href="{{route('res_index_cus_edit', ['id'=>$cusInfo->cus_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="{{route('res_remove_customer', ['id'=>$cusInfo->cus_id])}}" class="btn btn-link">Approve</a>
