        ...
        <main class="main">
                       ...
                       <li class="@indexactivehp"><a href="{{route('receptionist_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                          ...
                          <li class="@@colorsactive"><a href="{{route('res_check_map_bulk')}}">Bulk Booking</a></li>
                           @if($msg==5)
                           <li class="@@colorsactive"><a href="{{route('res_index_all_booking_list')}}">Booking List</a></li>
                           @else
                           <li class="@@colorsactive"><a href="{{route('res_index_booking_list')}}">Booking List</a></li>
                           @endif
                           <li class="navigation__active"><a href="{{route('res_index_check_booking_list')}}">Check Out Bookings</a></li>
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <a href="{{route('res_index_check_booking_list')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i> All Bookings</a>
                    <br><br>

                    {{Form::open(['action'=>'ReceptionistController@resCheckBookingSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'print_check_out_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateValidation()'])}}
                                ...
                                @foreach($bookingInfos as $bookingInfo)
                                    <tr style="font-size: 16px">
                                        ...
                                        @endif
                                           ...
                                           @if($bookingInfo->status==1)
                                           <td><a href="#" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-close"></i></a></td>
                                           @else
                                           <td>

                                           <button class="btn btn-light"  data-toggle="modal" data-target="#"><i  data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Cancel Booking" class="zmdi zmdi-close" disable></i></button><br><br>
                                          ...
                                          <td>
                                            ...
                                            <button class="btn btn-light"  data-toggle="modal" data-target="#"><i  data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Approve For Booking Modification" class="zmdi zmdi-border-color" disabled></i></button><br><br>
                                          ...
                                          @endif
                                            ...
                                            @else
                                              ...
                                              <td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Make Orders For Meals" href="#" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-cutlery"></i></a></td>
                                            @endif
                                            ...
                                            @else
                                              {{--<td><a href="{{route('admin_cancel_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-close"></i>For Cancel</a></td>--}}
                                              {{--<td><button class="btn btn-light" data-toggle="modal" data-target="#modal-default{{$bookingInfo->booking_id}}"><i style="font-size: 18px" class="zmdi zmdi-plus-circle-o"></i></button></td>--}}
                                              <td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Make Booking For Airport Pick Up/Drop" href="#" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-car-taxi"></i></a></td>
                                            @endif

                                            @if($bookingInfo->status==1)
                                              <td><button  class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-plus-circle-o" disabled></i></button></td>
                                            @else
                                              <td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Add another booking for invoice" href="#" class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-hotel"></i></a></td>
                                            @endif
