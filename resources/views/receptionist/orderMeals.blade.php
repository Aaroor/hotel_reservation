...
<li class="@@colorsactive"><a href="{{route('res_monthly_map')}}">Monthly Time Line</a></li>
                         ...
                         <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                          ...
                          <ul>
                           <li class="navigation__active"><a href="{{route('res_index_order_meals')}}">Choose Meals</a></li>
            ...
            <section class="content">
                ...
                {{Form::open(['action'=>'ReceptionistController@resAddBookingId','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                    <div class="row">
            ...
            {{Form::close()}}
             @else
             <a href="{{route('res_check_map')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-hotel"></i>Add Booking</a>
             <br><br>
             @endif
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="font-size: 16px">
                                    ...
                                    {{--</div>--}}
                                     {{Form::open(['action'=>'ReceptionistController@resAddMealsOrderP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
