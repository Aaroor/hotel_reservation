                       ...
                       <li class="@indexactivehp"><a href="{{route('receptionist_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                            ...
                            <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                              ...
                              <ul>
                               ...
                               <li class="navigation__active"><a href="{{route('res_bulk_booking_details')}}">Add Booking</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            {{Form::open(['action'=>'ReceptionistController@resAddBulkBookingP','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <a style="font-size: 16px" href="{{route('res_check_map_bulk')}}" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-accounts-list"></i> Back To Booking</a>
