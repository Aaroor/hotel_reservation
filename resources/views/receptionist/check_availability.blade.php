                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    	  ...
                    	  <ul>
                    	   ...
                    	   <li class="navigation__active"><a href="{{route('rec_available_rooms_index')}}">Availability List</a></li>
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-body">
                       ...
                       {{Form::open(['action'=>'ReceptionistController@recAvailableRoomsSearch','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <tbody>
                                     @foreach($roomInfos as $roomInfo)
                                        <tr style="font-size: 16px">
                                            ...
                                            @if($is_available->checkProcess($from_date,$to_date,$roomInfo->room_id)==0)
                                            <td><a href="{{route('res_index_booking_info', ['id'=>$roomInfo->room_id])}}" class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-arrow-forward"></i>For Booking</a></td>
                                            @elseif($is_available->checkProcess($from_date,$to_date,$roomInfo->room_id)==1)
                                            <td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Booking Cancel" href="{{route('res_cancel_booking', ['id'=>$remove_id->getBookingIdTwo($from_date,$to_date,$roomInfo->room_id)])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-close"></i></a>
                                            <a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Continue Booking" href="{{route('res_con_booking_info', ['id'=>$roomInfo->room_id,'from'=>$from_date,'to'=>$to_date])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-check"></i></a>
                                            </td>
                                            @else
