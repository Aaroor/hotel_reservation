                       ...
                       <li class="@indexactivehp"><a href="{{route('receptionist_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                            ...
                            <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                              ...
                              <ul>
                               ...
                               <li class="@@cssanimationsactive"><a href="{{route('res_index_booking_info', ['id'=>session('s_room_id')])}}">Add Booking</a></li>
                               <li class="navigation__active"><a href="{{route('res_index_booking_info', ['id'=>session('s_room_id')])}}">Edit Booking</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{Form::open(['action'=>'ReceptionistController@resEditDurationAvaP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                            ...
                            {{Form::open(['action'=>'ReceptionistController@resEditBooking','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
