...
<li class="@@colorsactive"><a href="{{route('res_monthly_map')}}">Monthly Time Line</a></li>
                       ...
                       <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                           ...
                           <ul>
                               ...
                               <li class="navigation__active"><a href="{{route('res_cus_questions')}}">FAQ Questions</a></li>
                           </ul>
                       </li>
            ...
            <section class="content">
             <a href="{{route('res_cus_questions_all')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>Search All</a>
             <br><br>
                                ...
                                @if(count($questionInfos)!=0)
                                 @foreach($questionInfos as $questionInfo)
                                	<tr style="font-size: 16px">
                                		...
                                		<td>{{$questionInfo->phone_no}}</td>
                                        <td>{{$questionInfo->address}}</td>
                                		<td><a href="#modal_{{$questionInfo->question_id}}" data-toggle="modal" data-target="#modal_{{$questionInfo->question_id}}">View Message ...</a></td>

                                        <td>{{$con_date_time->convertDate($questionInfo->add_date)}}</td>
                ...
                @foreach($questionInfos as $questionInfo)
                 ...
                 <div class="modal fade" id="modal_{{$questionInfo->question_id}}" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title pull-left">Customer Message</h5>
                            </div>
                            <div class="modal-body" style="font-size: 16px">
                                <div class="stats__chart" style="text-align: center">
                                    <i class="zmdi zmdi-local-post-office zmdi-hc-5x"></i>

                                </div>
                                <div class="row">
                                    <div class="col-sm-12">

                                        <p>{{$questionInfo->message}}</p>
