                       ...
                       <li class="@indexactivehp"><a href="{{route('receptionist_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                             ...
                             <ul>
                              ...
                              <li class="navigation__active"><a href="{{route('res_index_airport_booking_list')}}">Edit Booking</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                             {{Form::open(['action'=>'ReceptionistController@resEditAirPortBookingP','class'=>'form-horizontal form-label-left input_mask','name'=>'air_booking_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return airportBookingFormValidation()'])}}
