        ...
        <main class="main">
            ...
            <section class="content">
                <header class="content__title">
                    ...
                    {{--<div class="row">--}}
                      {{--<div class="col-sm-2">--}}
                        <a href="{{route('res_index_check_out_payment')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>Search All</a>
                      {{--</div>--}}
                                 ...
                                 <?php
                                  ...
                                  ?>
                                	...
                                	<tr style="font-size: 16px">
                                		...
                                		<td><a href="{{route('res_bill_payment', ['id'=>$checkOutInfo->invoice_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-money-box"></i></a></td>
                                        ...
                                        <td><a href="{{route('res_print_bill', ['id'=>$checkOutInfo->invoice_id])}}" class="btn btn-success btn--icon-text"><i style="font-size: 18px" class="zmdi zmdi-print"></i>Print</a></td>
                                        @else
