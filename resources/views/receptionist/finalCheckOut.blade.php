...
<li class="@@colorsactive"><a href="{{route('res_monthly_map')}}">Monthly Time Line</a></li>
                       ...
                       <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                           ...
                           <ul>
                               ...
                               <li class="navigation__active"><a href="{{route('res_check_out_info')}}">Final Check Outs</a></li>
            ...
            <section class="content">
                <header class="content__title">
                    <a href="{{route('res_check_out_info')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>All Search</a>
                ...
                <div class="card">
                    ...
                    <br><br>
                        ...
                        {{Form::open(['action'=>'ReceptionistController@recFinalCheckDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                        <div class="row">
                            <div class="col-sm-4">
