    ...
    <body data-sa-theme="{{$user_info->getUserInfo(session('user_id'))->theme_id}}">
        <main class="main">
                       ...
                       <li class="@indexactivehp"><a href="{{route('receptionist_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                          ...
                          <li class="@@colorsactive"><a href="{{route('res_check_map_bulk')}}">Bulk Booking</a></li>
                           @if($msg==5)
                           <li class="navigation__active"><a href="{{route('res_index_all_booking_list')}}">Booking List</a></li>
                           @else
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-body">
                    <a href="{{route('res_index_booking_list')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i> All Bookings</a>
                    <br><br>

                    {{Form::open(['action'=>'ReceptionistController@resBookingSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'print_check_out_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateValidation()'])}}
                                ...
                                @foreach($bookingInfos as $bookingInfo)
                                    <tr style="font-size: 16px">
                                        ...
                                        @endif
                                           ...
                                           @if($bookingInfo->status==1)
                                           <td><a href="{{route('res_stop_process', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-close"></i></a></td>
                                           @else
                                           ...
                                           @else
                                           <button class="btn btn-light"  data-toggle="modal" data-target="#modal-default_cancel{{$bookingInfo->booking_id}}"><i  data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Approve For Cancel" class="zmdi zmdi-close"></i></button><br><br>
                                           @endif
                                          ...
                                          <td>
                                          @if($bookingInfo->edit_lock==1)
                                           <a  href="{{route('res_edit_booking_info', ['id'=>$bookingInfo->booking_id])}}"  class="btn btn-light" data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Edit Booking"><i  style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>
                                          @else
                                            <button class="btn btn-light"  data-toggle="modal" data-target="#modal-default_edit{{$bookingInfo->booking_id}}"><i  data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Approve For Booking Modification" class="zmdi zmdi-border-color"></i></button><br><br>
                                          @endif
                                          </td>
                                          @if($bookingInfo->status==2)
                                          @if($check_details->getCheckOutInfo($bookingInfo->invoice_id)!=null)
                                          ...
                                          @if($bookingInfo->status==2)
                                           <td style="font-size: 14px"><strong><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Check out payment" href="{{route('res_pay_check', ['id'=>$bookingInfo->invoice_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-shopping-cart"></i></a></strong></td>
                                          @else
                                          ...
                                          @endif
                                            ...
                                            @else
                                              <td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Make Orders For Meals" href="{{route('res_re_meals_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-cutlery"></i></a></td>
                                            @endif
                                            ...
                                            @else
                                              ...
                                              <td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Make Booking For Airport Pick Up/Drop" href="{{route('res_re_air_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-car-taxi"></i></a></td>
                                            @endif

                                            @if($bookingInfo->status==1)
                                              <td><button  class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-plus-circle-o" disabled></i></button></td>
                                            @else
                                              <td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Add another booking for invoice" href="{{route('res_re_room_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-hotel"></i></a></td>
                                            @endif
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="{{route('res_remove_booking', ['id'=>$bookingInfo->booking_id])}}" class="btn btn-link">Approve</a>
                ...
                <div class="modal fade" id="modal-default_cancel{{$bookingInfo->booking_id}}" tabindex="-1">
                	<div class="modal-dialog">
                		<div class="modal-content">
                			<div class="modal-header">
                				<h5 class="modal-title pull-left">Approval Request For Room Cancellation</h5>
                			</div>
                			<div class="modal-body" style="font-size: 16px">
                			<p style="font-size:12px"><i class="zmdi zmdi-info-outline"></i>&nbspYou can't remove any room booking data with out manager approval. Please make a request to manger for an approval</p>
                				{{Form::open(['action'=>'ReceptionistController@resCancelBookingAppP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form'])}}
                					 <input type="hidden" value="{{$bookingInfo->booking_id}}" name="cancel_booking_id"/>
                						<div class="row">
                							<div class="col-sm-12">

                								<div class="form-group">
                									<label style="font-size: 16px"><b><i class="zmdi zmdi-play-for-work"></i>&nbsp Reason for cancel booking ?</b></label>
                									<textarea class="form-control" name="cancel_reason" style="font-size: 16px"  rows="4" cols="50"  placeholder="Type here ..." required></textarea>
                 ...
                 @foreach($bookingInfos as $bookingInfo)
                    ...
                    <div class="modal fade" id="modal-default_edit{{$bookingInfo->booking_id}}" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title pull-left">Approval Request For Rooms Booking Modifications</h5>
                                </div>
                                <div class="modal-body" style="font-size: 16px">
                                <p style="font-size:12px"><i class="zmdi zmdi-info-outline"></i>&nbspYou can't remove any rooms booking data with out manager approval. Please make a request to manger for an approval</p>
                                    {{Form::open(['action'=>'ReceptionistController@resEditBookingAppP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form'])}}
                                         <input type="hidden" value="{{$bookingInfo->booking_id}}" name="edit_booking_id"/>
                                            <div class="row">
                                                <div class="col-sm-12">

                                                    <div class="form-group">
                                                        <label style="font-size: 16px"><b><i class="zmdi zmdi-play-for-work"></i>&nbsp Reason for room booking modification ?</b></label>
