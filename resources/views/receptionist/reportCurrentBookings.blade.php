...
<li class="@@colorsactive"><a href="{{route('res_monthly_map')}}">Monthly Time Line</a></li>
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    		   ...
                    		   <li class="navigation__active"><a href="{{route('res_rep_current_booking')}}">Current Booking</a></li>
            ...
            <section class="content">
                <header class="content__title">
                    {{-- <a href="{{route('admin_rep_current_booking')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>All Search</a> --}}
                ...
                <div class="card">
                    ...
                    {{Form::open(['action'=>'ReceptionistController@resReportCurrentBookingDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'print_check_out_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateValidation()'])}}
                    @if($msg==0)
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                ...
                                <div class="input-group">
                                    <div class="form-group">
                                     @if($msg==0)
                                        {{-- <a href="{{route('admin_rep_current_booking_bill')}}" class="btn btn-success btn--icon-text"><i style="font-size: 18px" class="zmdi zmdi-print"></i> Print</a> --}}
                                     @else
                                        {{-- <a href="{{route('admin_rep_current_booking_bill_duration')}}" class="btn btn-success btn--icon-text"><i style="font-size: 18px" class="zmdi zmdi-print"></i> Print</a> --}}
                                     @endif
                                    </div>
                                </div>
                                 ...
                                 <?php
                                  ?>
                                    <tr style="font-size: 16px">
                                        <td>
                                            @if($cus_id->getCustomerId($bookingInfo->invoice_id)!=null)
                                            {{$cus_info->getCustomer($cus_id->getCustomerId($bookingInfo->invoice_id))->cus_first_name}} {{$cus_info->getCustomer($cus_id->getCustomerId($bookingInfo->invoice_id))->cus_last_name}}<br>
