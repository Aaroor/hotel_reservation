                         ...
                         <li class="@indexactivehp"><a href="{{route('receptionist_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                        	...
                        	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                        	  ...
                        	  <ul>
                        	   ...
                        	   <li class="navigation__active"><a href="{{route('res_index_cus_edit', ['id'=>$cusInfo->cus_id])}}">Edit Customer</a></li>
            ...
            <section class="content">
                <div class="content__inner">
                    ...
                    <header class="content__title">
                        ...
                        <div class="actions">
                                {{--<a href="{{route('admin_cus_list')}}" class="actions__item zmdi zmdi-accounts-list"></a>--}}
                                {{--<a href="{{route('index_cus_edit', ['id'=>$cusInfo->cus_id])}}" class="actions__item zmdi zmdi-refresh"></a>--}}
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            {{Form::open(['action'=>'ReceptionistController@resUpdateCustomer','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        ...
                                        <input type="hidden" value="{{$cusInfo->cus_id}}" name="cus_id">
                                        <div class="form-group">
                                            <label style="font-size: 16px">First Name  *</label>
                                            <input style="font-size: 16px" name="cus_first_name" type="text" class="form-control" value="{{$cusInfo->cus_first_name}}">
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="cus_last_name" type="text" class="form-control" value="{{$cusInfo->cus_last_name}}">
                                            <i class="form-group__bar"></i>
                                        </div>
                                    {{--</div>--}}
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="cus_mail" type="email" class="form-control" value="{{$cusInfo->cus_email}}">
                                            <i class="form-group__bar"></i>
                                        </div>
                                    {{--</div>--}}
                                    <div id="msg_cus_mail">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input style="font-size: 16px" name="cus_phone" type="number" class="form-control"  value="{{$cusInfo->cus_phone}}">
                                        <i class="form-group__bar"></i>
                                    </div>
                                    <br>
                                 ...
                                 <div class="col-sm-5">
                                     {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="cus_nic_pass" type="text" class="form-control" value="{{$cusInfo->cus_nic_pass}}">
                                            <i class="form-group__bar"></i>
                                        </div>
                                     {{--</div>--}}
                                     <br>
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="cus_address" type="text" class="form-control" value="{{$cusInfo->cus_address}}">
                                            <i class="form-group__bar"></i>
                                        </div>
                                    {{--</div>--}}
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <a style="font-size: 16px" href="{{route('res_cus_list')}}" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-accounts-list"></i> Customer List</a>
