                    ...
                    <ul class="navigation">
                         <li class="@indexactivehp"><a href="{{route('receptionist_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                        	...
                        	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                        	  ...
                        	  <ul>
                        	   <li class="navigation__active"><a href="{{route('res_index_add_customer')}}">Add Customer</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            {{Form::open(['action'=>'ReceptionistController@resAddCustomer','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input style="font-size: 16px" name="cus_phone" type="number" min="0" class="form-control" type="number" placeholder="0000000000000">
                                        <i class="form-group__bar"></i>
                                    </div>
                                    <br>
