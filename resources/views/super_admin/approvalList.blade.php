                                	...
                                	<tr style="font-size: 16px">
                                		...
                                		@if($appInfo->is_remove==0)
                                            @if($appInfo->data_type==1)
                                                <a href="{{route('admin_order_edit_app_r', ['id'=>$appInfo->app_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-check"></i></a>&nbsp
                                            @elseif($appInfo->data_type==0)
                                                <a href="{{route('admin_order_remove_app_r', ['id'=>$appInfo->app_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-check"></i></a>&nbsp
                                            @elseif($appInfo->data_type==2)
                                                <a href="{{route('admin_bill_print_app_r', ['id'=>$appInfo->app_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-check"></i></a>&nbsp
                                            @elseif($appInfo->data_type==3)
                                                <a href="{{route('admin_book_cancel_app_r', ['id'=>$appInfo->app_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-check"></i></a>&nbsp
                                            @elseif($appInfo->data_type==4)
                                                <a href="{{route('admin_book_edit_app_r', ['id'=>$appInfo->app_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-check"></i></a>&nbsp
                                            @elseif($appInfo->data_type==5)
                                                <a href="{{route('admin_air_book_edit_app_r', ['id'=>$appInfo->app_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-check"></i></a>&nbsp
                                            @elseif($appInfo->data_type==6)
                                                <a href="{{route('admin_air_book_remove_app_r', ['id'=>$appInfo->app_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-check"></i></a>&nbsp
                                            @elseif($appInfo->data_type==7)
                                                <a href="{{route('admin_pay_remove_app_r', ['id'=>$appInfo->app_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-check"></i></a>&nbsp

                                            @endif
                                        @else
                                            <a href="#" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-info-outline"></i></a>&nbsp
                                        @endif
                                		<a href="{{route('admin_remove_approvals', ['id'=>$appInfo->app_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-close"></i></a>
                                		</td>
