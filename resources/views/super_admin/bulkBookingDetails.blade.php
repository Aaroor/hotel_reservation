...
<html lang="en">
    ...
    <body data-sa-theme="{{$user_info->getUserInfo(session('user_id'))->theme_id}}">
                       ...
                       <li class="@@colorsactive"><a href="{{route('admin_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                           ...
                           <ul>
                               ...
                               <li class="navigation__active"><a href="{{route('admin_bulk_booking_details')}}">Add Booking</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            {{Form::open(['action'=>'SuperAdminController@adminAddBulkBookingP','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <a href="{{route('res_create_new_bulk_customer')}}" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-accounts-add"></i> Add New Customer</a>
                                    <br>
                                    <br>
                                </div>
                                <div class="col-sm-1">
                                ...
                                <input type="hidden"  name="bulkRoomIds[]" value="{{$roomInfo->room_id}}">
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="room_number1{{$roomInfo->room_id}}" type="text" class="form-control" value="{{$roomInfo->room_number}}" disabled>
                                            <input type="hidden" name="room_number{{$roomInfo->room_id}}" value="{{$roomInfo->room_number}}" />
                                            <i class="form-group__bar"></i>
                                        </div>
                                    {{--</div>--}}
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="floor_number{{$roomInfo->room_id}}" type="text" class="form-control" value="{{$roomInfo->floor_number}}" disabled>
                                            <i class="form-group__bar"></i>
                                        </div>
                                    {{--</div>--}}
                                ...
                                <div class="col-sm-1"></div>
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <select id="book_type" name="no_of_adults{{$roomInfo->room_id}}" class="select2" data-minimum-results-for-search="Infinity">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="book_type" name="no_of_children{{$roomInfo->room_id}}" class="select2" data-minimum-results-for-search="Infinity">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input style="font-size: 16px" name="number_of_d{{$roomInfo->room_id}}" type="number" class="form-control" value="{{$cal->countDay(session('from_date'),session('to_date'))}}" disabled>
                                        <input style="font-size: 16px" name="number_of_days{{$roomInfo->room_id}}" id="number_of_days{{$roomInfo->room_id}}" type="hidden" class="form-control" value="{{$cal->countDay(session('from_date'),session('to_date'))}}" >
                                        <i class="form-group__bar"></i>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input style="font-size: 16px" name="amount_per_day1{{$roomInfo->room_id}}" id="amp{{$roomInfo->room_id}}" type="number" oninput="setTotalAmount(this)" class="form-control" value="{{number_format((float)$roomInfo->room_price,2,'.','')}}">
                                        <input style="font-size: 16px" name="amount_per_day{{$roomInfo->room_id}}" id="amp1{{$roomInfo->room_id}}" type="hidden" class="form-control" value="{{number_format((float)$roomInfo->room_price,2,'.','')}}">
                                ...
                                <div class="col-sm-1"></div>
                                 ...
                                 <div class="col-sm-5">
                                     {{--<div class="input-group">--}}
                                        {{--<span class="input-group-addon">@</span>--}}
                                        <div class="form-group">
                                        <?php $totalAmount=$totalAmount+$cal->calPrice($roomInfo->room_price,$cal->countDay(session('from_date'),session('to_date')));?>
                                            <label style="font-size: 16px">Total Amount ( Rs )</label>
                                            <input style="font-size: 16px" name="total_amount1" id="total_amount1{{$roomInfo->room_id}}" type="text" class="form-control" value="{{number_format((float)$cal->calPrice($roomInfo->room_price,$cal->countDay(session('from_date'),session('to_date'))),2,'.','')}}" disabled>
                                            <input style="font-size: 16px" id="total_amount{{$roomInfo->room_id}}" name="total_amount{{$roomInfo->room_id}}"  type="hidden" class="form-control" value="{{number_format((float)$cal->calPrice($roomInfo->room_price,$cal->countDay(session('from_date'),session('to_date'))),2,'.','')}}">
                                            <input style="font-size: 16px" id="total_amountp1{{$roomInfo->room_id}}" name="total_amountp1"  type="hidden" class="form-control" value="{{number_format((float)$cal->calPrice($roomInfo->room_price,$cal->countDay(session('from_date'),session('to_date'))),2,'.','')}}">
                                            <i class="form-group__bar"></i>
                                        </div>
                                     {{--</div>--}}
                                     <br>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input style="font-size: 16px" name="total_book_amount" id="total_book_amount" type="text"  class="form-control" value="{{number_format((float)$totalAmount,2,'.','')}}" disabled>
                                        <input style="font-size: 16px" name="total_book_amount1" id="total_book_amount1" type="hidden"  class="form-control" value="{{number_format((float)$totalAmount,2,'.','')}}">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <a style="font-size: 16px" href="{{route('admin_check_map_bulk')}}" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-accounts-list"></i> Back To Booking</a>
        ...
        <script>
            function setTotalAmount($this)
            {
                var strId=$this.id;
                var id=strId.substring(3);
                var perAmId="amp"+id;

                var numDayId="number_of_days"+id;
                var tot1Id="total_amount1"+id;
                var totId="total_amount"+id;
                var totp1Id="total_amountp1"+id;

               var perAmount=document.getElementById(perAmId).value;

               var subPreAmount=document.getElementById(totp1Id).value;




               var totAmount=document.getElementById("total_book_amount1").value;
               var noOfDay=document.getElementById(numDayId).value;

               var changeTotalAmount=totAmount-subPreAmount;

               var newTotalAmount=changeTotalAmount+(perAmount*noOfDay);
...
//               var taxAmount=(perAmount*noOfDay)+((perAmount*noOfDay)*17)/100;
               document.getElementById(tot1Id).value=(perAmount*noOfDay).toFixed(2);
               document.getElementById(totId).value=(perAmount*noOfDay).toFixed(2);
               document.getElementById(totp1Id).value=(perAmount*noOfDay).toFixed(2);
               document.getElementById("total_book_amount").value=newTotalAmount.toFixed(2);
               document.getElementById("total_book_amount1").value=newTotalAmount.toFixed(2);
