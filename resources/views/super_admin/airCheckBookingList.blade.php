                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		 ...
                    		 <ul>
                    		  ...
                    		  <li class="navigation__active"><a href="{{route('admin_index_check_airport_booking_list')}}">Check Out Air Bookings</a></li>
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <br><br>
                        ...
                        @endif
                         {{Form::open(['action'=>'SuperAdminController@adminAirCheckDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'print_check_out_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateValidation()'])}}
                            <div class="row">
                                <div class="col-sm-4">
