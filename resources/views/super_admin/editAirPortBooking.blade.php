        ...
        <main class="main">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		 ...
                    		 <ul>
                    		  ...
                    		  <li class="navigation__active"><a href="{{route('admin_edit_air_booking', ['id'=>$aBookingInfo->a_booking_id])}}">Edit Booking</a></li>
            ...
            <section class="content">
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title" style="text-align: center"><u>Modify Airport Vehicle Booking</u></h3>
                            ...
                            <br>
                             {{Form::open(['action'=>'SuperAdminController@adminEditAirPortBookingP','class'=>'form-horizontal form-label-left input_mask','name'=>'air_booking_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return airportBookingFormValidation()'])}}
                            ...
                            <div class="row">
                            	...
                            	{{--@if(count($bookingInfos)!=0)--}}
                            		...
                            		<button style="font-size: 16px" type="submit" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-save"></i> Update Booking</button>
