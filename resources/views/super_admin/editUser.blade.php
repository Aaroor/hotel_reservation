        ...
        <main class="main">
            ...
            <aside class="sidebar">
                <div class="scrollbar-inner">
                    ...
                    <ul class="navigation">
                       <li class="navigation__active"><a href="{{route('admin_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                       ...
                       <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                         ...
                         <ul>
                       	  ...
                       	  @if($msg==2)
                       	  <li class="navigation__active"><a href="{{route('update_user_failure')}}">Update User Info</a></li>
                       	  @else
                       	  <li class="navigation__active"><a href="{{route('index_update_user', ['id'=>$userInfo->user_id])}}">Update User Info</a></li>
                       	  @endif
            ...
            <section class="content">
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title" style="text-align: center"><u>Update Receptionist</u></h3>
                            ...
                            <br>
                            {{Form::open(['action'=>'SuperAdminController@adminUpdateUser','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="user_name" type="text" class="form-control" value="{{$userInfo->user_name}}">
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="login_name" type="text" class="form-control" value="{{$userInfo->login_id}}">
                                            <i class="form-group__bar"></i>
                                        </div>
                                    {{--</div>--}}
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="user_mail" type="email" class="form-control" value="{{$userInfo->user_email}}">
                                            <i class="form-group__bar"></i>
                                        </div>
                                    {{--</div>--}}
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input style="font-size: 16px" name="user_phone" type="text" class="form-control input-mask" data-mask="(00) 0000-0000" value="{{$userInfo->telephone_no}}">
                                        <i class="form-group__bar"></i>
                                    </div>
                                    <br>
                                ...
                                <div class="col-sm-1"></div>
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <label style="font-size: 16px">User Role</label>

                                            <select name="user_role" class="select2" data-minimum-results-for-search="Infinity">
                                                @if($userInfo->user_role==0)
                                                <option style="font-size: 16px" value="0" selected>Receptionist</option>
                                                <option style="font-size: 16px" value="1">Manager</option>
                                                <option style="font-size: 16px" value="2">Admin</option>
                                                @elseif($userInfo->user_role==1)
                                                <option style="font-size: 16px" value="1" selected>Manager</option>
                                                <option style="font-size: 16px" value="2">Admin</option>
                                                <option style="font-size: 16px" value="0">Receptionist</option>

                                                @else
                                                <option style="font-size: 16px" value="2" selected>Admin</option>
                                                <option style="font-size: 16px" value="0">Receptionist</option>
                                                <option style="font-size: 16px" value="1">Manager</option>
                                 ...
                                 <div class="col-sm-5">
                                     {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="user_password" type="password" class="form-control" value="{{Crypt::decrypt($userInfo->user_password)}}">
                                            <i class="form-group__bar"></i>
                                        </div>
                                     {{--</div>--}}
                                     <br>
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="user_re_password" type="password" class="form-control" value="{{Crypt::decrypt($userInfo->user_password)}}">
                                            <i class="form-group__bar"></i>
                                        </div>
                                    {{--</div>--}}
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <a style="font-size: 16px" href="{{route('index_user_list')}}" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-accounts-list"></i> User List</a>
