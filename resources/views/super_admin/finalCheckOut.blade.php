        ...
        <main class="main">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--togglede">
                    		...
                    		<ul>
                    			...
                    			<li class="navigation__active"><a href="{{route('admin_check_out_info')}}">Final Check Outs</a></li>
                    		</ul>
                    	</li>
                    	<li class="navigation__sub @@uiactive">
            ...
            <section class="content">
                <header class="content__title">
                    <a href="{{route('admin_check_out_info')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>All Search</a>
                ...
                <div class="card">
                    ...
                    <br><br>
                        ...
                        {{Form::open(['action'=>'SuperAdminController@adminFinalCheckDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    ...
                                    @if(session()->has('search_date_final_check_from'))
                                        <input  type="text" name="from_date" class="form-control date-picker" value="{{session('search_date_final_check_from')}}">
                                    @else
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                    <div class="form-group">
                                    @if(session()->has('search_date_final_check_to'))
                                        <input id="dt" type="text" name="to_date" class="form-control date-picker" value="{{session('search_date_final_check_to')}}">
                                    @else
