                    ...
                    <ul class="navigation">
						...
						<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
							...
							<ul>
							   ...
							   <li class="navigation__active"><a href="{{route('admin_room_list')}}">Room List</a></li>
						   </ul>
						</li>
                ...
                <div class="card">
                    ...
                    <br><br>
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" style="font-size: 16px">
                            ...
                            <strong>Room number{{$cmt}}</strong><br> Already assign to another room please change the room number for update
                        </div>
                        @endif
                       
                        @inject('dec_room_type', 'App\Http\Controllers\SuperAdminController')
                        @inject('date_con', 'App\Http\Controllers\SuperAdminController')
                            ...
                            <table id="data-table" class="table">
                                ...
                                @foreach($roomInfos as $roomInfo)
                                    <tr style="font-size: 16px">
                                        ...
                                        <td>{{number_format((float)$roomInfo->room_price,2,'.','')}}</td>

                                        <td>{{$date_con->convertDate($roomInfo->add_date)}}</td>
                                        <td><a href="{{route('admin_edit_room_r', ['id'=>$roomInfo->room_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>&nbsp
                                        <button class="btn btn-light" data-toggle="modal" data-target="#modal-default{{$roomInfo->room_id}}"><i style="font-size: 18px" class="zmdi zmdi-delete"></i> </button>
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title pull-left">Make sure to remove room</h5>
                            </div>
                            <div class="modal-body" style="font-size: 16px">
                                ...
                                Please make sure this room <strong>{{$roomInfo->room_number}}</strong> remove from the system. If you approve room number <strong>{{$roomInfo->room_number}}</strong> will <strong>permanently remove</strong> from the system.
                            </div>
                            <div class="modal-footer">
                                <a href="{{route('admin_remove_room_r', ['id'=>$roomInfo->room_id])}}" class="btn btn-link">Approve</a>
