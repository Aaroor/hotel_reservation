                    	 ...
                    	 <li class="navigation__sub navigation__sub--active navigation__sub--toggle">
                    		...
                    		<ul>
                    			...
                    			<li class="@@colorsactive"><a href="{{route('admin_index_booking_info', ['id'=>session('s_room_id')])}}">Add Booking</a></li>
                    		     <li class="navigation__active"><a href="{{route('admin_create_new_customer')}}">Add Customer</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            {{Form::open(['action'=>'SuperAdminController@adminAddNewCustomer','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
