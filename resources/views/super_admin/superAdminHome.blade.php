                   ...
                   <br><br>
                            ...
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('admin_check_map')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a>
</small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        <h2>Meals Order</h2>
                                        <small> <a href="{{route('admin_index_order_meals')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a>
</small>
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="stats__item">
                               ...
                               <div class="stats__info">
                                   <div>
                                       ...
                                       <small> <a href="{{route('admin_index_airport_booking')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a>
</small>
                                   </div>
                               </div>
                           </div>
                            ...
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('admin_cus_list')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a>
</small>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row stats">
                        <div class="col-sm-6 col-md-3">
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        <h2>Payment</h2>
                                        <small> <a href="{{route('admin_index_check_out_payment')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('admin_meals_order_app')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="stats__item">
                                <div class="stats__chart" style="text-align: center">
                                    <i class="zmdi zmdi-airline-seat-flat zmdi-hc-5x"></i>
                                    {{--<img class="cir__img" src="{{ asset('demo/img/home/booking.jpg') }}" class="img-circle">--}}
                                </div>
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('admin_index_add_room')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('admin_add_meals')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row stats">
                        <div class="col-sm-6 col-md-3">
                            <div class="stats__item">
                                <div class="stats__chart" style="text-align: center">
                                    <i class="zmdi zmdi-tv-list zmdi-hc-5x"></i>
                                    {{--<img class="cir__img" src="{{ asset('demo/img/home/booking.jpg') }}" class="img-circle">--}}
                                </div>
                                ...
                                <div class="stats__info">
                                    <div>
                                        <h2>Reports</h2>
                                        <small> <a href="{{route('admin_day_summary')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        ...
                                        <small> <a href="{{route('admin_index_add_user')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="stats__item">
                                ...
                                <div class="stats__info">
                                    <div>
                                        <h2>User History</h2>
                                        <small> <a href="{{route('admin_cus_booking_history')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-arrow-forward"></i> Click To Move</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
