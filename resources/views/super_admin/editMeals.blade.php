        ...
        <main class="main">
                    ...
                    <ul class="navigation">
                    	<li class="@@colorsactive"><a href="{{route('admin_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                    	 ...
                    	 <li class="navigation__sub @@uiactive">
                    		...
                    		<ul>
                    			...
                    			<li class="@@cssanimationsactive"><a href="{{route('admin_index_booking_list')}}">Booking List</a></li>
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    		   ...
                    		   <li class="navigation__active"><a href="{{route('admin_edit_meals_r', ['id'=>$mealsInfo->meals_id])}}">Edit Meals</a></li>
            ...
            <header class="content__title">
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title" style="text-align: center"><u>Edit Previous Meal</u></h3>
                            ...
                            <br>
                            {{Form::open(['action'=>'SuperAdminController@adminEditMealsP','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}

                            <div class="row">
                                <div class="col-sm-1">
                                <input type="hidden" name="meals_id" value="{{$mealsInfo->meals_id}}"/>
                                </div>
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        {{--<span class="input-group-addon">*</span>--}}
                                        <div class="form-group">
                                            <label style="font-size: 16px">Meals Name</label>
                                            <input style="font-size: 16px" name="meals_name" type="text" class="form-control" value="{{$mealsInfo->meals_name}}">
                                ...
                                <div class="col-sm-5">
                                        ...
                                        <div class="form-group">
                                            <label style="font-size: 16px">Meals Type</label>

                                            <select name="meals_type" class="select2" data-minimum-results-for-search="Infinity">
                                            @if($mealsInfo->meals_type==0)
                                                <option style="font-size: 16px" value="0" selected>Break Fast</option>
                                                <option style="font-size: 16px" value="1">Lunch</option>
                                                <option style="font-size: 16px" value="2">Dinner</option>
                                                <option style="font-size: 16px" value="3">Short Eats</option>
                                                <option style="font-size: 16px" value="4">Drinks</option>
                                            @elseif($mealsInfo->meals_type==1)
                                                <option style="font-size: 16px" value="0">Break Fast</option>
                                                <option style="font-size: 16px" value="1" selected>Lunch</option>
                                                <option style="font-size: 16px" value="2">Dinner</option>
                                                <option style="font-size: 16px" value="3">Short Eats</option>
                                                <option style="font-size: 16px" value="4">Drinks</option>
                                            @elseif($mealsInfo->meals_type==2)
                                                <option style="font-size: 16px" value="0">Break Fast</option>
                                                <option style="font-size: 16px" value="1">Lunch</option>
                                                <option style="font-size: 16px" value="2"  selected>Dinner</option>
                                                <option style="font-size: 16px" value="3">Short Eats</option>
                                                <option style="font-size: 16px" value="4">Drinks</option>
                                            @elseif($mealsInfo->meals_type==3)
                                                <option style="font-size: 16px" value="0">Break Fast</option>
                                                <option style="font-size: 16px" value="1">Lunch</option>
                                                <option style="font-size: 16px" value="2">Dinner</option>
                                                <option style="font-size: 16px" value="3" selected>Short Eats</option>
                                                <option style="font-size: 16px" value="4">Drinks</option>
                                            @else
                                            <option style="font-size: 16px" value="0">Break Fast</option>
                                            <option style="font-size: 16px" value="1">Lunch</option>
                                            <option style="font-size: 16px" value="2">Dinner</option>
                                            <option style="font-size: 16px" value="3">Short Eats</option>
                                            <option style="font-size: 16px" value="4" selected>Drinks</option>
                                            @endif
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        {{--<span class="input-group-addon">*</span>--}}
                                        <div class="form-group">
                                            <label style="font-size: 16px">Available Time Start  </label>


                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                                <div class="form-group">
                                                    <input type="text" name="available_start_time" class="form-control time-picker" value="{{$mealsInfo->available_start_time}}">
                                                    <i class="form-group__bar"></i>
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label style="font-size: 16px">Available Time End </label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                            <div class="form-group">
                                                <input type="text" name="available_end_time" class="form-control time-picker" value="{{$mealsInfo->available_end_time}}">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-1"></div>
                                 ...
                                 <div class="col-sm-5">
                                        ...
                                        <div class="form-group">
                                            <label style="font-size: 16px">Style of meals</label>

                                            <select name="style_of_food" class="select2" data-minimum-results-for-search="Infinity">
                                            @if($mealsInfo->style_of_food==0)
                                                <option style="font-size: 16px" value="0" selected>Sri Lankan</option>
                                                <option style="font-size: 16px" value="1">Indian</option>
                                                <option style="font-size: 16px" value="2">Western</option>
                                                <option style="font-size: 16px" value="3">Other</option>
                                            @elseif($mealsInfo->style_of_food==1)
                                                <option style="font-size: 16px" value="0">Sri Lankan</option>
                                                <option style="font-size: 16px" value="1" selected>Indian</option>
                                                <option style="font-size: 16px" value="2">Western</option>
                                                <option style="font-size: 16px" value="3">Other</option>
                                            @elseif($mealsInfo->style_of_food==2)
                                                <option style="font-size: 16px" value="0">Sri Lankan</option>
                                                <option style="font-size: 16px" value="1">Indian</option>
                                                <option style="font-size: 16px" value="2" selected>Western</option>
                                                <option style="font-size: 16px" value="3">Other</option>
                                            @else
                                                <option style="font-size: 16px" value="0" selected>Sri Lankan</option>
                                                <option style="font-size: 16px" value="1">Indian</option>
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label style="font-size: 16px">Price per unit (Rs)*</label>
                                        <input style="font-size: 16px" name="price_per_unit" type="number" step="any" class="form-control" value="{{$mealsInfo->price_per_unit}}">
                                        <i class="form-group__bar"></i>
                                    </div>
                                ...
                                <div class="col-sm-1"></div>
                                <div class="col-sm-5">
                                    <button style="font-size: 16px" type="submit" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-save"></i> Update</button>
                                    <a style="font-size: 16px" href="{{route('admin_meals_list')}}" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-accounts-list"></i> Meals List</a>
