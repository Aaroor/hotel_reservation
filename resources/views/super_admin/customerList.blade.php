        ...
        <main class="main">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    		   ...
                    		   <li class="navigation__active"><a href="{{route('admin_cus_list')}}">Customer List</a></li>
                    	   </ul>
                    	</li>
            ...
            <section class="content">
                <header class="content__title">
                    ...
                    <div class="actions">
                            <a href="{{route('admin_index_add_customer')}}" class="actions__item zmdi zmdi-account-add"></a>
                            <a href="{{route('admin_cus_list')}}" class="actions__item zmdi zmdi-refresh"></a>
                ...
                <div class="card">
                            ...
                            <table id="data-table" class="table">
                                ...
                                @foreach($cusInfos as $cusInfo)
                                    <tr style="font-size: 16px">
                                        <td>
                                           {{$cusInfo->cus_first_name}}
                                        </td>
                                        <td>
                                          {{$cusInfo->cus_last_name}}

                                        </td>
                                        <td>{{$cusInfo->cus_email}}</td>

                                        <td>{{$cusInfo->cus_phone}}</td>

                                        <td>{{$cusInfo->cus_nic_pass}}</td>
                                        <td><a href="{{route('admin_index_cus_edit', ['id'=>$cusInfo->cus_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>&nbsp
                 ...
                 <div class="modal fade" id="modal-default{{$cusInfo->cus_id}}" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title pull-left">Make sure to remove customer</h5>
                            </div>
                            <div class="modal-body" style="font-size: 16px">
                                ...
                                Please make sure customer <strong>{{$cusInfo->cus_first_name." ".$cusInfo->cus_last_name}}</strong> remove from the system. If you approve <strong>{{$cusInfo->cus_last_name}}</strong> will <strong>permanently remove</strong> from the system.
                            </div>
                            <div class="modal-footer">
                                <a href="{{route('admin_remove_customer', ['id'=>$cusInfo->cus_id])}}" class="btn btn-link">Approve</a>
