                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		 ...
                    		 <ul>
                    		  ...
                    		  <li class="navigation__active"><a href="{{route('admin_index_airport_booking_list')}}">Booking List</a></li>
                                ...
                                <tbody>
                                 @foreach($aBookingInfos as $aBookingInfo)
                                	<tr style="font-size: 16px">
                                		...
                                		<td style="font-size: 14px"><strong><a href="{{route('admin_bill_payment', ['id'=>$aBookingInfo->invoice_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-money"></i></a></strong></td>

                                        <td style="font-size: 14px"><strong><a href="{{route('admin_pay_check', ['id'=>$aBookingInfo->invoice_id])}}" class="btn btn-light btn--icon-text" href=""><i class="zmdi zmdi-shopping-cart"></i></a></strong></td>

                                		<td>

                                		<a href="{{route('admin_edit_air_booking', ['id'=>$aBookingInfo->a_booking_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>&nbsp
                         ...
                         <div class="modal fade" id="modal-default_remove{{$aBookingInfo->a_booking_id}}" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a href="{{route('admin_remove_air_booking', ['id'=>$aBookingInfo->a_booking_id])}}" class="btn btn-link">Approve</a>
                                        <button type="button" class="btn btn-link" data-dismiss="modal">Close</button>
                                    </div>
                                </div>
                            </div>
