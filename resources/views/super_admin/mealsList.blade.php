                    ...
                    <ul class="navigation">
						...
						<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
							...
							<ul>
							   ...
							   <li class="navigation__active"><a href="{{route('admin_meals_list')}}">Meals List</a></li>
                                ...
                                <tbody>
                                 @foreach($mealsInfos as $mealsInfo)
                                	<tr style="font-size: 16px">
                                		...
                                		{{--<td></td>--}}
                                		<td><a href="{{route('admin_edit_meals_r', ['id'=>$mealsInfo->meals_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>&nbsp
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="{{route('admin_remove_meals_r', ['id'=>$mealsInfo->meals_id])}}" class="btn btn-link">Approve</a>
