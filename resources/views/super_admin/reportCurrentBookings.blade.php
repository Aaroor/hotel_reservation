        ...
        <main class="main">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    		   ...
                    		   <li class="navigation__active"><a href="{{route('admin_rep_current_booking')}}">Current Booking Report</a></li>
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    {{Form::open(['action'=>'SuperAdminController@adminReportCurrentBookingDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'print_check_out_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateValidation()'])}}
                    @if($msg==0)
