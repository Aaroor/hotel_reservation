        ...
        <main class="main">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    		   ...
                    		   <li class="navigation__active"><a href="{{route('admin_edit_room_r', ['id'=>$roomInfo->room_id])}}">Edit Room</a></li>
            ...
            <section class="content">
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title" style="text-align: center"><u>Add Room</u></h3>
                            ...
                            <div class="row">
                                ...
                                @elseif($msg==2)
                                     <div class="alert alert-danger alert-dismissible fade show">
                                            ...
                                            <strong>{{$cmt}}</strong><br> This room already in the system please try with different room number
                                     </div>
                                @endif
                                </div>
                            ...
                            <br>
                            {{Form::open(['action'=>'SuperAdminController@adminEditRoomsP','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="room_number" type="text" class="form-control" value="{{$roomInfo->room_number}}" required>
                                            <i class="form-group__bar"></i>
                                        </div>
                                  
                                    <div id="msg_room_number">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <select name="floor_number" class="select2" data-minimum-results-for-search="Infinity">
                                        @if($roomInfo->floor_number==1)
                                            <option style="font-size: 16px" value="1" selected>Floor 1</option>
                                            <option style="font-size: 16px" value="2">Floor 2</option>
                                            <option style="font-size: 16px" value="3">Floor 3</option>
                                            <option style="font-size: 16px" value="4">Floor 4</option>
                                            <option style="font-size: 16px" value="5">Floor 5</option>
                                        @elseif($roomInfo->floor_number==2)
                                            <option style="font-size: 16px" value="1">Floor 1</option>
                                            <option style="font-size: 16px" value="2" selected>Floor 2</option>
                                            <option style="font-size: 16px" value="3">Floor 3</option>
                                            <option style="font-size: 16px" value="4">Floor 4</option>
                                            <option style="font-size: 16px" value="5">Floor 5</option>
                                        @elseif($roomInfo->floor_number==3)
                                            <option style="font-size: 16px" value="1">Floor 1</option>
                                            <option style="font-size: 16px" value="2">Floor 2</option>
                                            <option style="font-size: 16px" value="3" selected>Floor 3</option>
                                            <option style="font-size: 16px" value="4">Floor 4</option>
                                            <option style="font-size: 16px" value="5">Floor 5</option>
                                        @elseif($roomInfo->floor_number==4)
                                            <option style="font-size: 16px" value="1">Floor 1</option>
                                            <option style="font-size: 16px" value="2">Floor 2</option>
                                            <option style="font-size: 16px" value="3">Floor 3</option>
                                            <option style="font-size: 16px" value="4" selected>Floor 4</option>
                                            <option style="font-size: 16px" value="5">Floor 5</option>
                                        @else
                                            <option style="font-size: 16px" value="1">Floor 1</option>
                                            <option style="font-size: 16px" value="2">Floor 2</option>
                                            <option style="font-size: 16px" value="3">Floor 3</option>
                                            <option style="font-size: 16px" value="4">Floor 4</option>
                                            <option style="font-size: 16px" value="5" selected>Floor 5</option>
                                        @endif
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <select name="room_type" class="select2" data-minimum-results-for-search="Infinity">
                                         @if($roomInfo->room_type==0)
                                            <option style="font-size: 16px" value="0" selected>Single Room</option>
                                            <option style="font-size: 16px" value="1">Deluxe Double Room</option>
                                            <option style="font-size: 16px" value="2">Deluxe Triple Room</option>
                                            <option style="font-size: 16px" value="3">Conference Hall</option>
                                         @elseif($roomInfo->floor_number==1)
                                            <option style="font-size: 16px" value="0">Single Room</option>
                                            <option style="font-size: 16px" value="1" selected>Deluxe Double Room</option>
                                            <option style="font-size: 16px" value="2">Deluxe Triple Room</option>
                                            <option style="font-size: 16px" value="3">Conference Hall</option>
                                         @elseif($roomInfo->floor_number==2)
                                            <option style="font-size: 16px" value="0">Single Room</option>
                                            <option style="font-size: 16px" value="1">Deluxe Double Room</option>
                                            <option style="font-size: 16px" value="2" selected>Deluxe Triple Room</option>
                                            <option style="font-size: 16px" value="3">Conference Hall</option>
                                         @else
                                            <option style="font-size: 16px" value="0">Single Room</option>
                                            <option style="font-size: 16px" value="1">Deluxe Double Room</option>
                                            <option style="font-size: 16px" value="2">Deluxe Triple Room</option>
                                            <option style="font-size: 16px" value="3" selected>Conference Hall</option>
                                         @endif
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-10">
                                <div class="form-group">
                                    <label style="font-size: 16px">Room Description</label>
                                    <textarea style="font-size: 16px" name="room_description" class="form-control" value="{{$roomInfo->room_description}}"></textarea>
                                    <i class="form-group__bar"></i>
                                </div>
                                </div>
                                ...
                                <div class="col-sm-10">
                                <div class="form-group">
                                    <label style="font-size: 16px">Amount (Rs)*</label>
                                    <input style="font-size: 16px" name="room_price" type="number" step="any" min="1" class="form-control" value="{{number_format((float)$roomInfo->room_price,2,'.','')}}" required>
                                    <i class="form-group__bar"></i>
                                </div>
                                <div id="msg_room_price">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <a style="font-size: 16px" href="{{route('admin_room_list')}}" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-accounts-list"></i> Room List</a>
