    ...
    <body data-sa-theme="{{$user_info->getUserInfo(session('user_id'))->theme_id}}">
        <main class="main">
                ...
                <div class="scrollbar-inner">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    			<li class="navigation__active"><a href="{{route('admin_index_order_meals')}}">Choose Meals</a></li>
            ...
            <section class="content">
                ...
                {{Form::open(['action'=>'SuperAdminController@adminAddBookingId','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                    <div class="row">
                    	...
                    	<div class="col-sm-8">
                    		<div class="form-group">
                    			...
                    			@foreach($bookingInfos as $bookingInfo)
                    			    @if(strcmp($bookingInfo->booking_id,session('o_booking_id'))==0)
            ...
            {{Form::close()}}
             @else
             <a href="{{route('admin_check_map')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-hotel"></i>Add Booking</a>
             <br><br>
             @endif

                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title" style="text-align: center"><u>Make order for selected booking</u></h3>
                            ...
                            <div class="row">
                                ...
                                @if($msg==1)
                                    <div class="alert alert-success alert-dismissible fade show">
                                        ...
                                        <strong>{{$cmt}}</strong><br> Successfully ordered.
                                    </div>
                                @elseif($msg==2)
                            	...
                            	<table id="data-table" class="table">
                            		<thead>
                            			<tr style="font-size: 16px;font-weight: bold">
                            				...
                            				<th><i>Time End</i></th>
                            				<th><i>Meals Style</i></th>
                            				<th><i>Price/Unit(Rs)</i></th>
                            				<th><i>Action</i></th>
                            			</tr>
                            		</thead>
                            		<tbody>
                            		 @foreach($mealsInfos as $mealsInfo)
                            			<tr style="font-size: 16px">
                            				...
                            				{{--<td></td>--}}
                            				{{--<td><a href="{{route('index_update_user', ['id'=>$roomInfo->room_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>&nbsp--}}
                            			    <td><button class="btn btn-light" data-toggle="modal" data-target="#modal-default{{$mealsInfo->meals_id}}"><i style="font-size: 18px" class="zmdi zmdi-plus-circle-o"></i> Add Order </button></td>
                            				{{--</td>--}}
                            			</tr>
                            		@endforeach
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title pull-left">Make Order For {{$mealsInfo->meals_name}}</h5>
                                </div>
                                <div class="modal-body" style="font-size: 16px">
                                    ...
                                    {{--</div>--}}
                                     {{Form::open(['action'=>'SuperAdminController@adminAddMealsOrderP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                                     <input type="hidden" value="{{$mealsInfo->meals_id}}" name="meals_id"/>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input  type="text" name="order_date" class="form-control date-picker" value="{{$book_details1->getBookingInfo(session('o_booking_id'))->from_date}}" required>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                                    <div class="form-group">
                                                        <input type="text" name="order_time" class="form-control time-picker" value="{{$mealsInfo->available_start_time}}" required>
                                                        <i class="form-group__bar"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                             <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input style="font-size: 16px" id="qu{{$mealsInfo->meals_id}}" oninput="amountCal(this)" name="quantity" type="number" min="0" class="form-control" value="1" required>
                                                    <i class="form-group__bar"></i>
                                                </div>
                                             </div>
                                             <div class="col-sm-6">
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <input style="font-size: 16px" id="up{{$mealsInfo->meals_id}}" oninput="amountCal(this)" name="price_per_unit" type="number" min="0" class="form-control" value="{{number_format((float)$mealsInfo->price_per_unit,2,'.','')}}" required>
                                                     <i class="form-group__bar"></i>
                                                 </div>
                                             </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                 <div class="form-group">
                                                 <?php $total_amount=$mealsInfo->price_per_unit*1;?>
                                                     <label style="font-size: 16px">TotalAmount *</label>
                                                     <input style="font-size: 16px" id="tm{{$mealsInfo->meals_id}}"  name="total_am" type="number" min="0" class="form-control" value="{{number_format((float)$total_amount,2,'.','')}}" disabled>
                                                     <input type="hidden" name="total_amount" id="ta{{$mealsInfo->meals_id}}" value="{{number_format((float)$total_amount,2,'.','')}}" />
                                                     <i class="form-group__bar"></i>
                                                 </div>
                                             </div>
                                            <div class="col-sm-6">
                                                ...
                                                <label style="font-size:11px">Name : {{$cus_details1->getCustomerFirstName($book_details1->getBookCustomerId(session('o_booking_id')))}} {{$cus_details1->getCustomerLastName($book_details1->getBookCustomerId(session('o_booking_id')))}}</label>
                                                <br>
                                                <label style="font-size:11px">Room No  : {{$room_details1->getRoomDetails($book_details1->getBookingInfo(session('o_booking_id'))->room_id)->room_number}} </label>
                                                <br>
                                                <label style="font-size:11px">Duration : {{$book_details1->getBookingInfo(session('o_booking_id'))->from_date}} To {{$book_details1->getBookingInfo(session('o_booking_id'))->to_date}}</label>
                                                @endif
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-link">Add Order</button>
