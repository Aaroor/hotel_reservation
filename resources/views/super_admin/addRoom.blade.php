                ...
                <div class="scrollbar-inner">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    		   <li class="navigation__active"><a href="{{route('admin_index_add_room')}}">Add Room</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            {{Form::open(['action'=>'SuperAdminController@adminAddRooms','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="room_number" type="text" class="form-control" placeholder="eg : #100" required>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <select name="floor_number" class="select2" data-minimum-results-for-search="Infinity">
                                            ...
                                            <option style="font-size: 16px" value="4">Floor 5</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="font-size: 16px" name="room_description" class="form-control" placeholder="Type Description..."></textarea>
                                    <i class="form-group__bar"></i>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="font-size: 16px" name="room_price" type="number" step="any" min="1" class="form-control" placeholder="0000.00" required>
                                    <i class="form-group__bar"></i>
                                </div>
