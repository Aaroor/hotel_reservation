        ...
        <main class="main">
                       ...
                       <li class="navigation__active"><a href="{{route('admin_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                           ...
                           <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                             ...
                             <ul>
                              ...
                              <li class="navigation__active"><a href="{{route('index_user_list')}}">User List</a></li>
            ...
            <section class="content">
                <header class="content__title">
                    ...
                    <div class="actions">
                            <a href="{{route('index_user_list')}}" class="actions__item zmdi zmdi-refresh"></a>
                ...
                <div class="card">
                            ...
                            <table id="data-table" class="table">
                                ...
                                @foreach($userInfos as $userInfo)
                                    <tr style="font-size: 16px">
                                        ...
                                        <td>Admin</td>
                                        @endif
                                        <td>{{$userInfo->add_date}}</td>
                                        <td><a href="{{route('index_update_user', ['id'=>$userInfo->user_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-border-color"></i></a>&nbsp
                                        <button class="btn btn-light" data-toggle="modal" data-target="#modal-default{{$userInfo->user_id}}"><i style="font-size: 18px" class="zmdi zmdi-delete"></i> </button>
                                        </td>
                                    </tr>
                                @endforeach
                 ...
                 <div class="modal fade" id="modal-default{{$userInfo->user_id}}" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="font-size: 16px">
                                ...
                                Please make sure receptionist <strong>{{$userInfo->user_name}}</strong> remove from the system. If you approve login name <strong>{{$userInfo->login_id}}</strong> will <strong>permanently remove</strong> from the system.
                            </div>
                            <div class="modal-footer">
                                <a href="{{route('remove_user', ['id'=>$userInfo->user_id])}}" class="btn btn-link">Approve</a>
