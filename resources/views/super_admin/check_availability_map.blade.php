                    ...
                    <ul class="navigation">
                    	<li class="@@colorsactive"><a href="{{route('admin_home')}}"><i class="zmdi zmdi-home"></i> Home</a></li>
                    	 ...
                    	 <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    			<li class="navigation__active"><a href="{{route('admin_check_map')}}">Availability Map</a></li>
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{route('admin_check_map_bulk')}}" data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="For Bulk Booking" class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-arrow-forward"></i>Go To Bulk Booking</a>
                        <br>
                                ...
                                <div class="col-sm-4 col-md-2">
                                    <div class="stats__item" style="background-color: green">
                                        <div class="stats__chart" style="text-align: center;">
                                            ...
                                            <a href="{{route('admin_index_booking_info', ['id'=>$roomInfo->room_id])}}" data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="For Booking" class="btn btn-light btn--icon-text" ><i class="zmdi zmdi-arrow-forward"></i></a>
                                            <br>
                                        </div>
                                ...
                                <div class="col-sm-4 col-md-2">
                                    <div class="stats__item" style="background-color: orange">
                                        <div class="stats__chart" style="text-align: center;">
                                            ...
                                            <h4>{{$roomInfo->room_number}}</h4>
                                            <h6>{{$dec_room_type->getRoomType($roomInfo->room_type)}}</h6>
                                            <a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Booking Cancel" href="{{route('admin_cancel_booking', ['id'=>$remove_id->getBookingIdTwo($from_date,$to_date,$roomInfo->room_id)])}}" class="btn btn-danger btn--icon-text" href=""><i class="zmdi zmdi-close"></i></a>
                                            <a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Continue Booking" href="{{route('admin_con_booking_info', ['id'=>$roomInfo->room_id,'from'=>$from_date,'to'=>$to_date])}}" class="btn btn-success btn--icon-text" href=""><i class="zmdi zmdi-check"></i></a>
                                        </div>
