        ...
        <main class="main">
                ...
                <div class="scrollbar-inner">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    		   <li class="navigation__active"><a href="{{route('admin_add_meals')}}">Add Meals</a></li>
            ...
            <header class="content__title">
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title" style="text-align: center"><u>Add New Meals</u></h3>
                            ...
                            <br>
                            {{Form::open(['action'=>'SuperAdminController@adminAddMealsP','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="font-size: 16px" name="meals_name" type="text" class="form-control" placeholder="eg : Meals Name">
                                    ...
                                    {{--<div class="input-group">--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="available_start_time" class="form-control time-picker" placeholder="Pick a time">
                                                    <i class="form-group__bar"></i>
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                            <div class="form-group">
                                                <input type="text" name="available_end_time" class="form-control time-picker" placeholder="Pick a time">
                                                <i class="form-group__bar"></i>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input style="font-size: 16px" name="price_per_unit" type="number" step="any" class="form-control" placeholder="0000.00">
                                        <i class="form-group__bar"></i>
                                    </div>
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <a style="font-size: 16px" href="{{route('admin_cus_list')}}" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-accounts-list"></i> Meals List</a>
