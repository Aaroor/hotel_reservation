                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    		   ...
                    		   <li class="navigation__active"><a href="{{route('admin_bill_payment', ['id'=>session('p_invoice_id')])}}">Bill Payment</a></li>
                    		   <li class="@@colorsactive"><a href="{{route('admin_payment_preview', ['id'=>session('p_invoice_id')])}}">Payment Preview</a></li>
                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                         ...
                         {{Form::open(['action'=>'SuperAdminController@adminAddPayment','class'=>'form-horizontal form-label-left input_mask','name'=>'user_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return userFormValidation()'])}}
                            <div class="row">
