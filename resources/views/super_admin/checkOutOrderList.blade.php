    ...
    <body data-sa-theme="{{$user_info->getUserInfo(session('user_id'))->theme_id}}">
        <main class="main">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    			...
                    			<li class="navigation__active"><a href="{{route('admin_index_check_order_list')}}">Check Out Orders</a></li>
            ...
            <section class="content">
             <a href="{{route('admin_index_check_order_list')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>Search All</a>
             <br><br>
                ...
                <div class="card">
                    ...
                    <br><br>
                        ...
                        {{Form::open(['action'=>'SuperAdminController@adminOrderCheckDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'print_check_out_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateValidation()'])}}
                        	<div class="row">
                        		<div class="col-sm-4">
