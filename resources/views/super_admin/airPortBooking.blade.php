                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{Form::open(['action'=>'SuperAdminController@adminAddBookingIdA','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                                <div class="row">
                             ...
                             {{Form::close()}}
                             @else
                             <a href="{{route('admin_available_rooms_index')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-hotel"></i>Add Booking</a>
                             <br><br>
                             @endif


                            <br>
                            {{Form::open(['action'=>'SuperAdminController@adminAirPortBookingP','class'=>'form-horizontal form-label-left input_mask','name'=>'air_booking_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return airportBookingFormValidation()'])}}
                            ...
                            <div class="row">
                                ...
                                @endif
                                    <a style="font-size: 16px" href="{{route('admin_index_airport_booking_list')}}" class="btn btn-dark btn--icon-text"><i class="zmdi zmdi-accounts-list"></i> Booking List</a>
