        ...
        <main class="main">
                    ...
                    <ul class="navigation">
                    	...
                    	<li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                    		...
                    		<ul>
                    		   ...
                    		   <li class="navigation__active"><a href="{{route('admin_rep_check_rooms')}}">Check Out Rooms Report</a></li>
                    	   </ul>
                    	</li>
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    {{Form::open(['action'=>'SuperAdminController@adminReportCheckRoomsDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'print_check_out_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return twoDateValidation()'])}}
                       @if($msg==0)
