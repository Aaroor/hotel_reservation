        ...
        <main class="main">
                ...
                <div class="scrollbar-inner">
                   ...
                   <ul class="navigation">
                   	...
                   	<li class="navigation__sub navigation__sub--active navigation__sub--togglede">
                   		...
                   		<ul>
                   			<li class="navigation__active"><a href="{{route('admin_index_check_out_payment')}}">Payment Check Out</a></li>
            ...
            <section class="content">
                <header class="content__title">
                    ...
                    {{--<div class="row">--}}
                      {{--<div class="col-sm-2">--}}
                        <a href="{{route('admin_index_check_out_payment')}}" class="btn btn-light btn--icon-text"><i class="zmdi zmdi-search"></i>Search All</a>
                      {{--</div>--}}
                ...
                <div class="card">
                    ...
                    <br><br>
                        ...
                        {{Form::open(['action'=>'SuperAdminController@adminCheckOutDateSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                            <div class="row">
                                <div class="col-sm-4">
                        ...
                        {{Form::open(['action'=>'SuperAdminController@adminCheckOutDurationSearchP','class'=>'form-horizontal form-label-left input_mask','name'=>'edit_res_form', 'method'=>'POST','role'=>'form','onsubmit'=>'return editResFormValidation()'])}}
                        <div class="row">
                            <div class="col-sm-4">
                                 ...
                                 <?php
                                  ...
                                  ?>
                                	...
                                	<tr style="font-size: 16px">
                                		...
                                		<td><a data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="Paid History For Invoice" href="{{route('admin_payment_history_r', ['id'=>$checkOutInfo->invoice_id])}}" class="btn btn-light"><i style="font-size: 18px" class="zmdi zmdi-time-restore"></i></a></td>
                                		<td><a href="{{route('admin_bill_payment', ['id'=>$checkOutInfo->invoice_id])}}" class="btn btn-light" href=""><i style="font-size: 18px" class="zmdi zmdi-money-box"></i></a></td>
                                        ...
                                        <td><a href="{{route('admin_print_bill', ['id'=>$checkOutInfo->invoice_id])}}" class="btn btn-success btn--icon-text"><i style="font-size: 18px" class="zmdi zmdi-print"></i>Print</a></td>
                                        @else
