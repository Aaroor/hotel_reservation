...
$stmt->bindParam(1,$date_time);
    ...
    if($num>0){
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
            ...
            $val= $val."<a href='https://system.nellymarine.com/super_admin/admin_booking_detail/{$booking_id}' class='listview__item'>
...
$stmt1->bindParam(1,$date_time);
    ...
    if($num1>0){
        ...
        while ($row1 = $stmt1->fetch(PDO::FETCH_ASSOC)){
            ...
            $val= $val."<a href='https://system.nellymarine.com/super_admin/admin_order_detail/{$order_id}' class='listview__item'>
...
$stmt2->bindParam(1,$date_time);
    ...
    if($num2>0){
        while ($row2 = $stmt2->fetch(PDO::FETCH_ASSOC)){
            ...
            $val= $val."<a href='https://system.nellymarine.com/super_admin/admin_air_detail/{$a_booking_id}' class='listview__item'>
