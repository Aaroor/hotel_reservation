/**
 * Created by Aaroor on 1/6/2018.
 */


function resFormValidation(){
    var userName=document.res_form.user_name.value;
    var loginName=document.res_form.login_name.value;
    var userEmail=document.res_form.user_mail.value;
    var userPhone=document.res_form.user_phone.value;
    var userPassword=document.res_form.user_password.value;
    var reUserPassword=document.res_form.user_re_password.value;
...
function editResFormValidation(){
    var userName=document.edit_res_form.user_name.value;
    var loginName=document.edit_res_form.login_name.value;
    var userEmail=document.edit_res_form.user_mail.value;
    var userPhone=document.edit_res_form.user_phone.value;
    var userPassword=document.edit_res_form.user_password.value;
    var reUserPassword=document.edit_res_form.user_re_password.value;
    var msgUserName=document.getElementById("msg_user_name");
    var msgLoginName=document.getElementById("msg_login_name");
    var msgUserMail=document.getElementById("msg_user_mail");
    var msgUserPhone=document.getElementById("msg_user_phone");
