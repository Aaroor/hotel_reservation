...
function showRoomBook() {
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/manPhpFolder/roomsBookingNotification.php?q=" + $str, true);
    xmlhttp.send();
}
function showMealsOut() {
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/manPhpFolder/mealsBookingNotification.php?q=" + $str, true);
    xmlhttp.send();
...
function showAirOut() {
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/manPhpFolder/airBookingNotification.php?q=" + $str, true);
    xmlhttp.send();
...
function showTodayNotify() {
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/manPhpFolder/todayNotification.php?q=" + $str, true);
    xmlhttp.send();
...
function browserNotify($userId) {
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/manPhpFolder/browserNotify.php?q=" +$userId, true);
    xmlhttp.send();
...
function notifyMeals($id,$msg) {
    if (Notification.permission !== "granted")
        ...
        notification.onclick = function () {
            window.open("https://system.nellymarine.com/manager/man_order_detail/"+$id,"_self");
        };
...
function notifyAir($id,$msg) {
    if (Notification.permission !== "granted")
        ...
        notification.onclick = function () {
            window.open("https://system.nellymarine.com/manager/man_air_detail/"+$id,"_self");
        };
...
function changeTheme($this)
{
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/manPhpFolder/themeChange.php?q=" +user_id+"&r="+themeValue, true);
    xmlhttp.send();
