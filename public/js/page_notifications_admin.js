...
function showRoomBook() {
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/adminPhpFolder/roomsBookingNotification.php?q=" + $str, true);
    xmlhttp.send();
}
function showMealsOut() {
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/adminPhpFolder/mealsBookingNotification.php?q=" + $str, true);
    xmlhttp.send();
...
function showAirOut() {
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/adminPhpFolder/airBookingNotification.php?q=" + $str, true);
    xmlhttp.send();
...
function showTodayNotify() {
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/adminPhpFolder/todayNotification.php?q=" + $str, true);
    xmlhttp.send();
...
function browserNotify($userId) {
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/adminPhpFolder/browserNotify.php?q=" +$userId, true);
    xmlhttp.send();
...
function notifyRoom($id,$msg) {
    if (Notification.permission !== "granted")
        ...
        notification.onclick = function () {
            window.open("https://system.nellymarine.com/super_admin/admin_booking_detail/"+$id,"_self");
        };
...
function notifyMeals($id,$msg) {
    if (Notification.permission !== "granted")
        ...
        var notification = new Notification('Meals Order', {
            icon: 'https://system.nellymarine.com/demo/img/profile-pics/meals.jpg',
            body: $msg
        });

        notification.onclick = function () {
            window.open("https://system.nellymarine.com/super_admin/admin_order_detail/"+$id,"_self");
        };
...
function notifyAir($id,$msg) {
    if (Notification.permission !== "granted")
        ...
        notification.onclick = function () {
            window.open("https://system.nellymarine.com/super_admin/admin_air_detail/"+$id,"_self");
        };
...
function changeTheme($this)
{
    ...
    xmlhttp.open("GET", "https://system.nellymarine.com/adminPhpFolder/themeChange.php?q=" +user_id+"&r="+themeValue, true);
    xmlhttp.send();
