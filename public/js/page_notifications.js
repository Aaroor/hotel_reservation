...
function showRoomBook() {
    ...
    xmlhttp.open("GET", "http://localhost/hotel_reservation/phpFolder/roomsBookingNotification.php?q=" + $str, true);
    xmlhttp.send();
    }
function showMealsOut() {
    ...
    xmlhttp.open("GET", "http://localhost/hotel_reservation/phpFolder/mealsBookingNotification.php?q=" + $str, true);
    xmlhttp.send();
...
function showAirOut() {
    ...
    xmlhttp.open("GET", "http://localhost/hotel_reservation/phpFolder/airBookingNotification.php?q=" + $str, true);
    xmlhttp.send();
...
function showTodayNotify() {
    ...
    xmlhttp.open("GET", "http://localhost/hotel_reservation/phpFolder/todayNotification.php?q=" + $str, true);
    xmlhttp.send();
...
function browserNotify($userId) {
    ...
    xmlhttp.open("GET", "http://localhost/hotel_reservation/phpFolder/browserNotify.php?q=" +$userId, true);
    xmlhttp.send();
...
function notifyRoom($id,$msg) {
    ...
    icon: 'http://localhost/hotel_reservation/demo/img/profile-pics/room.jpg',
    body: $msg
    });

    notification.onclick = function () {
    window.open("http://localhost/hotel_reservation/receptionist/res_booking_detail/"+$id,"_self");
    };
...
function notifyMeals($id,$msg) {
    ...
    icon: 'http://localhost/hotel_reservation/demo/img/profile-pics/meals.jpg',
    body: $msg
    });

    notification.onclick = function () {
    window.open("http://localhost/hotel_reservation/receptionist/res_order_detail/"+$id,"_self");
    };
...
function notifyAir($id,$msg) {
    ...
    icon: 'http://localhost/hotel_reservation/demo/img/profile-pics/taxi.jpg',
    body: $msg
    });

    notification.onclick = function () {
    window.open("http://localhost/hotel_reservation/receptionist/res_air_detail/"+$id,"_self");
    };
...
function changeTheme($this)
{
    ...
    xmlhttp.open("GET", "http://localhost/hotel_reservation/phpFolder/themeChange.php?q=" +user_id+"&r="+themeValue, true);
    xmlhttp.send();
