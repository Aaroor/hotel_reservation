...
try {
    ...
    if($num1>0){
        ...
        while ($row1 = $stmt1->fetch(PDO::FETCH_ASSOC)){
            ...
            $val= $val."<a href='http://localhost/hotel_reservation/receptionist/res_order_detail/{$order_id}' class='listview__item'>
                                            <img src='http://localhost/hotel_reservation/demo/img/profile-pics/meals.jpg' class='listview__img' alt=''>
    ...
    if($num2>0){
        while ($row2 = $stmt2->fetch(PDO::FETCH_ASSOC)){
            ...
            $val= $val."<a href='http://localhost/hotel_reservation/receptionist/res_air_detail/{$a_booking_id}' class='listview__item'>
